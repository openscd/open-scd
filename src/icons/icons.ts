...
export type iconType = 'action' | 'dAIcon' | 'dOIcon' | 'enumIcon' | 'info' | 'warning' | 'enumIcon' | 'error' | 'reset' | 'sclhistory' | 'reportIcon' | 'smvIcon' | 'gooseIcon' | 'lNIcon' | 'logIcon'
...
const pathsSVG = {
  ...
  lNIcon: svg`<path stroke="currentColor" stroke-width="1.89" fill="none" d="m4.2 0.945h18.1c1.8 0 3.25 1.45 3.25 3.25v11.6c0 1.8-1.45 3.25-3.25 3.25h-18.1c-1.8 0-3.25-1.45-3.25-3.25v-11.6c0-1.8 1.45-3.25 3.25-3.25z" stroke-width="1.89"/><path fill="currentColor" d="m5.71 15v-10h1.75v8.39h4.47v1.62z"/><path fill="currentColor" d="m18.2 15-3.63-7.71q0.107 1.12 0.107 1.8v5.9h-1.55v-10h1.99l3.69 7.77q-0.107-1.07-0.107-1.95v-5.82h1.55v10z"/>`,

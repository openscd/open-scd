// patterns are evolving over the years and thus with higher versions of the standards.
...
const typeBase = {
  IP:
    '([0-9]{1,2}|1[0-9]{2}|2[0-4][0-9]|25[0-5])\\.([0-9]{1,2}|1[0-9]{2}|2[0-4][0-9]|25[0-5])\\.([0-9]{1,2}|[0-9]{2}|2[0-4][0-9]|25[0-5])\\.([0-9]{1,2}|1[0-9]{2}|2[0-4][0-9]|25[0-5])',
  OSI: '[0-9A-F]+',
  OSId: '[0-9]+',
  OSIAPi: '[0-9\u002C]+',
  MAC:

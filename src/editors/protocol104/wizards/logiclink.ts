...
export function remove(element: Element, redundancyGroupNumber: number, logicLinkNumber: number): WizardMenuActor {
  return (): EditorAction[] => {
...
export function editLogicLinkWizard(element: Element, redundancyGroupNumber: number, logicLinkNumber: number): Wizard {
  return [
    {
      ...
      menuActions: [
        {
          icon: 'delete',
          label: get('remove'),
          action: remove(element, redundancyGroupNumber, logicLinkNumber),
        },
      ],
      primary: {
        icon: 'save',

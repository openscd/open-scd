...
/** [[`SubstationEditor`]] subeditor for a `ConnectivityNode` element. */
@customElement('connectivity-node-editor')
export class ConnectivityNodeEditor extends LitElement {
        ...
        ${this.readonly
          ...
          : html`<mwc-fab
              ...
              <mwc-fab
                ...
                @click="${() =>
                  startMove(this, ConnectivityNodeEditor, BayEditor)}"
                icon="forward"
              ></mwc-fab>
              <mwc-fab
                mini

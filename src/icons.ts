...
export const addReportIcon = svg`<svg style="width:24px;height:24px" viewBox="0 0 24 24">
  <path fill="currentColor" d="M9,7H13A2,2 0 0,1 15,9V11C15,11.84 14.5,12.55 13.76,12.85L15,17H13L11.8,13H11V17H9V7
         M11,9V11H13V9H11M18 14V17H15V19H18V22H20V19H23V17H20V14H18ZM14.3 21.7C13.6 21.9 12.8 22 12 22C6.5 22 2 17.5 2 12S6.5 2 12 2S22 6.5 22 12C22 12.8 21.95 13 21.95 13C21.3 12.5 20.7 12.2 20 12C20 7.6 16.4 4 12 4S4 7.6 4 12
     S7.6 20 12 20C12.4 20 12.9 20 13.3 19.9C13.5 20.6 13.9 21.2 14.3 21.7"/>
</svg>`;

...
import { ifImplemented, Mixin } from '@openscd/open-scd/src/foundation.js';
import { EditingElement } from '@openscd/open-scd/src/Editing.js';
...
export function Plugging<
  TBase extends new (...args: any[]) => EditingElement & HistoringElement
>(Base: TBase) {

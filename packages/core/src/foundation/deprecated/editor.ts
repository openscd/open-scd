 ...
 * 
 * @param action {@link EditorAction}
 * @returns SimpleAction {@link SimpleAction}
 */
 ...
 * @since 0.0.1
 *
 * @deprecated Use {@link newEditEvent} instead
 *
 * @param [`action`] Action that will be wrapped in a custom event - see {@link EditorAction}
 * @param [`eventInitDict`]  see {@link EditorActionDetail}
 * @returns [`EditorActionEvent`] see {@link EditorActionEvent}
 */

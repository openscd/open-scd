...
var util;
(function (util) {
    let PluggingElement = class PluggingElement extends Plugging(LitElement) {
    };
    PluggingElement = __decorate([
        customElement('plugging-element')
    ], PluggingElement);
    util.PluggingElement = PluggingElement;
})(util || (util = {}));
describe('Plugging Element', () => {
    let editor;
    beforeEach(async () => {
        editor = (await fixture(html `<plugging-element></plugging-element>`));
    });
...
//# sourceMappingURL=Plugging.spec.js.map
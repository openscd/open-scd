...
declare const OpenSCD_base: typeof LitElement & (new (...args: any[]) => LitElement & import("./mixins/EditingV2.js").EditingMixin) & (new (...args: any[]) => LitElement & import("./mixins/Plugging.js").PluginMixin);
/**
 *

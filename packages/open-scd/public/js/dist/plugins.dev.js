...
var officialPlugins = [{
  ...
  name: 'Open project',
  src: '/plugins/src/menu/OpenProject.js',
  icon: 'folder_open',
  "default": true,
  kind: 'menu',
  requireDoc: false,
  ...
  name: 'Save project',
  src: '/plugins/src/menu/SaveProject.js',
  icon: 'save',
  "default": true,
  kind: 'menu',
  requireDoc: true,
  ...
  name: 'Import IEDs',
  src: '/plugins/src/menu/ImportIEDs.js',
  icon: 'snippet_folder',
  "default": true,
  kind: 'menu',
  requireDoc: true,
  ...
  src: '/plugins/src/menu/UpdateSubstation.js',
  icon: 'merge_type',
  "default": true,
  kind: 'menu',
  requireDoc: true,
  ...
  name: 'Compare IED',
  src: '/plugins/src/menu/CompareIED.js',
  icon: 'compare_arrows',
  "default": true,
  kind: 'menu',
  requireDoc: true,

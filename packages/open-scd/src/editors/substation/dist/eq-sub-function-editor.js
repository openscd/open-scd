...
exports.EqSubFunctionEditor = void 0;
...
var EqSubFunctionEditor = /** @class */ (function (_super) {
    __extends(EqSubFunctionEditor, _super);
    function EqSubFunctionEditor() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.editCount = -1;
        _this.showfunctions = false;
        return _this;
    }
    Object.defineProperty(EqSubFunctionEditor.prototype, "header", {
        get: function () {
    ...
    EqSubFunctionEditor.prototype.openEditWizard = function () {
        var wizard = wizard_library_js_1.wizards['EqSubFunction'].edit(this.element);
        if (wizard)
            this.dispatchEvent(foundation_js_1.newWizardEvent(wizard));
    };
    EqSubFunctionEditor.prototype.remove = function () {
    ...
    EqSubFunctionEditor.prototype.openCreateWizard = function (tagName) {
        var wizard = wizard_library_js_1.wizards[tagName].create(this.element);
        if (wizard)
            this.dispatchEvent(foundation_js_1.newWizardEvent(wizard));
    };
    EqSubFunctionEditor.prototype.updated = function () {
        this.addMenu.anchor = this.addButton;
    };
    EqSubFunctionEditor.prototype.renderLNodes = function () {
        var _this = this;
    ...
    EqSubFunctionEditor.prototype.renderEqSubFunctions = function () {
        var _this = this;
    ...
    EqSubFunctionEditor.prototype.render = function () {
        var _this = this;
        return lit_element_1.html(templateObject_7 || (templateObject_7 = __makeTemplateObject(["<action-pane label=\"", "\" icon=\"functions\" secondary\n      ><abbr slot=\"action\" title=\"", "\">\n        <mwc-icon-button\n          icon=\"edit\"\n          @click=", "\n        ></mwc-icon-button> </abbr\n      ><abbr slot=\"action\" title=\"", "\">\n        <mwc-icon-button\n          icon=\"delete\"\n          @click=", "\n        ></mwc-icon-button> </abbr\n      ><abbr\n        slot=\"action\"\n        style=\"position:relative;\"\n        title=\"", "\"\n      >\n        <mwc-icon-button\n          icon=\"playlist_add\"\n          @click=", "\n        ></mwc-icon-button\n        ><mwc-menu\n          corner=\"BOTTOM_RIGHT\"\n          menuCorner=\"END\"\n          @action=", "\n          >", "</mwc-menu\n        ></abbr\n      >\n      ", "\n      ", "", "</action-pane\n    >"], ["<action-pane label=\"", "\" icon=\"functions\" secondary\n      ><abbr slot=\"action\" title=\"", "\">\n        <mwc-icon-button\n          icon=\"edit\"\n          @click=", "\n        ></mwc-icon-button> </abbr\n      ><abbr slot=\"action\" title=\"", "\">\n        <mwc-icon-button\n          icon=\"delete\"\n          @click=", "\n        ></mwc-icon-button> </abbr\n      ><abbr\n        slot=\"action\"\n        style=\"position:relative;\"\n        title=\"", "\"\n      >\n        <mwc-icon-button\n          icon=\"playlist_add\"\n          @click=", "\n        ></mwc-icon-button\n        ><mwc-menu\n          corner=\"BOTTOM_RIGHT\"\n          menuCorner=\"END\"\n          @action=",
    ...
    EqSubFunctionEditor.styles = lit_element_1.css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    abbr {\n      text-decoration: none;\n      border-bottom: none;\n    }\n\n    .container.lnode {\n      display: grid;\n      grid-gap: 12px;\n      padding: 8px 12px 16px;\n      box-sizing: border-box;\n      grid-template-columns: repeat(auto-fit, minmax(64px, auto));\n    }\n  "], ["\n    abbr {\n      text-decoration: none;\n      border-bottom: none;\n    }\n\n    .container.lnode {\n      display: grid;\n      grid-gap: 12px;\n      padding: 8px 12px 16px;\n      box-sizing: border-box;\n      grid-template-columns: repeat(auto-fit, minmax(64px, auto));\n    }\n  "])));
    __decorate([
        lit_element_1.property({ attribute: false })
    ], EqSubFunctionEditor.prototype, "doc");
    __decorate([
        lit_element_1.property({ type: Number })
    ], EqSubFunctionEditor.prototype, "editCount");
    __decorate([
        lit_element_1.property({ attribute: false })
    ], EqSubFunctionEditor.prototype, "element");
    __decorate([
        lit_element_1.property({ type: Boolean })
    ], EqSubFunctionEditor.prototype, "showfunctions");
    __decorate([
        lit_element_1.state()
    ], EqSubFunctionEditor.prototype, "header");
    __decorate([
        lit_element_1.query('mwc-menu')
    ], EqSubFunctionEditor.prototype, "addMenu");
    __decorate([
        lit_element_1.query('mwc-icon-button[icon="playlist_add"]')
    ], EqSubFunctionEditor.prototype, "addButton");
    EqSubFunctionEditor = __decorate([
        lit_element_1.customElement('eq-sub-function-editor')
    ], EqSubFunctionEditor);
    return EqSubFunctionEditor;
}(lit_element_1.LitElement));
exports.EqSubFunctionEditor = EqSubFunctionEditor;

...
import { newActionEvent, newWizardEvent, wizardInputSelector, isWizardFactory, checkValidity, reportValidity, identity, formatXml, } from './foundation.js';
function isWizardInput(input) {
    if (input.kind) {
        return true;
    }
    return false;
...
let WizardDialog = class WizardDialog extends LitElement {
    ...
    renderPage(page, index) {
        ...
        const extraWidth = showCodeToggleButton && page.menuActions
            ? 96

...
import { newOpenDocEvent, newPendingStateEvent, newSettingsUIEvent, } from './foundation.js';
...
__decorate([
    property({ attribute: false })
], OpenSCD.prototype, "validated", void 0);
__decorate([
    query('#menu')
], OpenSCD.prototype, "menuUI", void 0);
__decorate([
    query('#pluginManager')
], OpenSCD.prototype, "pluginUI", void 0);
__decorate([
    query('#pluginList')
], OpenSCD.prototype, "pluginList", void 0);
__decorate([
    query('#pluginAdd')
], OpenSCD.prototype, "pluginDownloadUI", void 0);
OpenSCD = __decorate([

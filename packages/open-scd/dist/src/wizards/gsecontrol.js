...
import { cloneElement, createElement, find, getUniqueElementName, getValue, identity, isPublic, newActionEvent, newSubWizardEvent, newWizardEvent, } from '../foundation.js';
    ...
    return [
        {
            ...
            content: [
                html `<filtered-list
          @selected=${(e) => {
                    const gseControlIndentity = e.target.selected
                        .value;

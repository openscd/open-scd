...
import { cloneElement, createElement, getChildElementsByTagName, getValue, } from '../foundation.js';
...
export function editTransformerWindingWizard(element) {
    ...
    const reservedNames = getChildElementsByTagName(element.parentElement, 'TransformerWinding')

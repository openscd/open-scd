...
import { compareNames, getValue, createElement, isPublic, identity, } from '../foundation.js';
import { getTypes, typeMaxLength, typeNullable, typePattern, } from './foundation/p-types.js';
import { mACAddressGenerator, appIdGenerator, } from '../foundation/generators.js';
...
function createConnectedApAction(parent) {
    return (_, __, list) => {
        ...
        const actions = identities.map(identity => {
            ...
            actions.push(...initSMVElements(doc, connectedAp, {
                macGeneratorSmv,
                appidGeneratorSmv,
                unconnectedSampledValueControl,
            }));
            actions.push(...initGSEElements(doc, connectedAp, {
                macGeneratorGse,
                appidGeneratorGse,

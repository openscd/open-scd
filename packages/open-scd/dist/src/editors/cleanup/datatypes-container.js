...
import { customElement, css, html, LitElement, property, query, queryAll, } from 'lit-element';
...
import { identity, isPublic, newLogEvent, newSubWizardEvent, newActionEvent, } from '../../foundation.js';
import { styles } from '../templates/foundation.js';
import { dataTypeTemplateIcons, getFilterIcon, } from '../../icons/icons.js';
...
let CleanupDataTypes = class CleanupDataTypes extends LitElement {
    constructor() {
        super(...arguments);
            ...
            cleanItems.forEach(item => {
                if (['DOType', 'DAType'].includes(item.tagName)) {
                    ...
                    unusedDataTypeTemplateChildrenIds.forEach(id => {
                        if (dataTypeUsageCounter.get(id) === undefined)
    ...
    renderDeleteButton() {
      ...
      icon="delete"
      class="delete-button"
      label="${translate('cleanup.unreferencedDataTypes.deleteButton')} (${this.selectedDataTypeItems.size || '0'})"
      ?disabled=${this.selectedDataTypeItems.size === 0 ||
    ...
    renderUnreferencedDataTypes() {
      ...
      <footer>
        ...
        <mwc-formfield
          ...
          label="${translate('cleanup.unreferencedDataTypes.alsoRemoveSubTypes')}"
        >
...
], CleanupDataTypes.prototype, "doc", void 0);
__decorate([
    property({ type: Boolean })
], CleanupDataTypes.prototype, "disableControlClean", void 0);
__decorate([
    property({ type: Array })
], CleanupDataTypes.prototype, "unreferencedDataTypes", void 0);
__decorate([
    property({ attribute: false })
], CleanupDataTypes.prototype, "selectedDataTypeItems", void 0);
__decorate([
    query('.delete-button')
], CleanupDataTypes.prototype, "cleanButton", void 0);
__decorate([
    query('.cleanup-list')
], CleanupDataTypes.prototype, "cleanupList", void 0);
__decorate([
    queryAll('mwc-check-list-item.cleanup-list-item')
], CleanupDataTypes.prototype, "cleanupListItems", void 0);
__decorate([
    query('.clean-sub-types-checkbox')
], CleanupDataTypes.prototype, "cleanSubTypesCheckbox", void 0);
__decorate([
    query('.t-da-type-filter')
], CleanupDataTypes.prototype, "cleanupDATypeFilter", void 0);
__decorate([
    query('.t-enum-type-filter')
], CleanupDataTypes.prototype, "cleanupEnumTypeFilter", void 0);
__decorate([
    query('.t-lnode-type-filter')
], CleanupDataTypes.prototype, "cleanupLNodeTypeFilter", void 0);
__decorate([
    query('.t-do-type-filter')
], CleanupDataTypes.prototype, "cleanupDOTypeFilter", void 0);
CleanupDataTypes = __decorate([
    customElement('cleanup-data-types')
], CleanupDataTypes);
export { CleanupDataTypes };
//# sourceMappingURL=datatypes-container.js.map
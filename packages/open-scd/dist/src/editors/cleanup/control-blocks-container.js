...
import { identity, isPublic, newSubWizardEvent, newActionEvent, } from '../../foundation.js';
import { styles } from '../templates/foundation.js';
import { controlBlockIcons, getFilterIcon, } from '../../icons/icons.js';
    ...
    renderListItem(controlBlock) {
      ...
      <span>
        <mwc-icon-button
          ...
          icon="warning_amber"
          class="cautionItem"
          title="${translate('cleanup.unreferencedControls.addressDefinitionTooltip')}"
    ...
    renderUnreferencedControls() {
      ...
      <footer>
        ...
        <mwc-formfield
          ...
          label="${translate('cleanup.unreferencedControls.alsoRemoveFromCommunication')}"
        >
          <mwc-checkbox
            checked

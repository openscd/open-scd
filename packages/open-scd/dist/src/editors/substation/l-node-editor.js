...
import { html, LitElement, property, customElement, state, } from 'lit-element';
import '../../action-icon.js';
import { cloneElement, identity, newActionEvent, newLnInstGenerator, newWizardEvent, } from '../../foundation.js';
import { automationLogicalNode, controlLogicalNode, functionalLogicalNode, furtherPowerSystemEquipmentLogicalNode, generalLogicalNode, interfacingLogicalNode, measurementLogicalNode, nonElectricalLogicalNode, powerTransformerLogicalNode, protectionLogicalNode, protectionRelatedLogicalNode, qualityLogicalNode, supervisionLogicalNode, switchgearLogicalNode, systemLogicalNode, transformerLogicalNode, } from '../../icons/lnode.js';

...
import { tagValidator, validateChildren, } from '../../../../src/validators/templates/foundation.js';
describe('validator foundation', () => {
    ...
    describe('validateChildren', () => {
        let element;
        beforeEach(() => {
            element = new DOMParser().parseFromString('<Element name="name"><NoTag></NoTag></Element>', 'application/xml').documentElement;
        });

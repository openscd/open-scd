    ...
    describe('dispatch', () => {
      ...
      `);
        ...
        it('triggers as newIssuesEvent for detail not containing kind', () => {
            ...
            expect(issueEvent.args[0][0].detail.validatorId).to.equal('/src/validators/ValidateTemplates.js');
    ...
    describe('validate', () => {
      ...
      `);
        ...
        it('pushes only diag.zeroissues issue to diagnostics when no issues found', async () => {
            ...
            expect(issueEvent.args[0][0].detail.title).to.contain('No errors found in the project');
        });
        it('pushes only diag.missingnsd issue to diagnostics pane for SCL version < 2007B3', async () => {
            ...
            await element.validate();
            expect(issueEvent).to.have.been.calledOnce;
            expect(issueEvent.args[0][0].detail.title).to.contain('Cannot validate DataTypeTemplates. The version of the project must be higher than or equal to 2007B3');
        });
...
//# sourceMappingURL=ValidateTemplates.test.js.map
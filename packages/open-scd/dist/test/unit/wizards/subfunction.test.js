...
import { createSubFunctionWizard, editSubFunctionWizard, } from '../../../src/wizards/subfunction.js';
describe('Wizards for SCL Function element', () => {
    ...
    describe('define an edit wizard that', () => {
        beforeEach(async () => {
            const wizard = editSubFunctionWizard(doc.querySelector('Bay[name="COUPLING_BAY"] > Function[name="bayName"] > SubFunction[name="myBaySubFunc"]'));
            element.workflow.push(() => wizard);
            await element.requestUpdate();
            inputs = Array.from(element.wizardUI.inputs);
            primaryAction = (element.wizardUI.dialog?.querySelector('mwc-button[slot="primaryAction"]'));
...
//# sourceMappingURL=subfunction.test.js.map
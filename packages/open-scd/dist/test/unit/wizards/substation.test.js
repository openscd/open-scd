...
import { executeWizardCreateAction, expectReplaceAction, expectUpdateAction, expectWizardNoUpdateAction, fetchDoc, setWizardTextFieldValue, } from './test-support.js';
import { updateNamingAttributeWithReferencesAction } from '../../../src/wizards/foundation/actions.js';
import { createAction, createSubstationWizard, substationEditWizard, } from '../../../src/wizards/substation.js';
describe('Wizards for SCL element Substation', () => {
    ...
    describe('edit existing Substation', () => {
        ...
        it('update name should be updated in document', async function () {
            await setWizardTextFieldValue(inputs[0], 'OtherSub1');
            const complexAction = updateNamingAttributeWithReferencesAction(substation, 'substation.action.updatesubstation')(inputs, element.wizardUI);
        ...
        it('when no fields changed there will be no update action', async function () {
            expectWizardNoUpdateAction(updateNamingAttributeWithReferencesAction(substation, 'substation.action.updatesubstation'), element.wizardUI, inputs);
        });
    ...
    describe('add new Substation', () => {
        ...
        it('create new Substation', async function () {
            await setWizardTextFieldValue(inputs[0], 'NewSub');

...
import { getCustomField, getDateValueFromTimestamp, getTimeValueFromTimestamp, } from '../../../../src/wizards/foundation/dai-field-type.js';
    ...
    describe('getCustomField', () => {
        ...
        describe('BOOLEAN field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['BOOLEAN'];
        ...
        describe('ENUM field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['Enum'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('FLOAT32 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['FLOAT32'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('FLOAT64 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['FLOAT64'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT8 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT8'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT16 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT16'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT24 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT24'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT32 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT32'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT64 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT64'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT128 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT128'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT8U field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT8U'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT16U field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT16U'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT24U field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT24U'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('INT32U field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['INT32U'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('Timestamp field', async () => {
            async function prepareTimestamp(daElement, daiElement) {
                customField = getCustomField()['Timestamp'];
                element = await fixture(html ` <oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('VisString32 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['VisString32'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('VisString64 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['VisString64'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('VisString65 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['VisString65'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('VisString129 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['VisString129'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
        ...
        describe('VisString255 field', async () => {
            beforeEach(async () => {
                ...
                customField = getCustomField()['VisString255'];
                element = await fixture(html `<oscd-wizards .host=${document}></oscd-wizards>`);
                element.workflow.push(() => wizard(customField, daElement, daiElement));
                await element.requestUpdate();
                inputs = Array.from(element.wizardUI.inputs);
...
//# sourceMappingURL=dai-field-type.test.js.map
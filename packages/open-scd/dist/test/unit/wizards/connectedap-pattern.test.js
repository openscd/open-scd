...
import { ipV6, ipV6SubNet, invertedRegex, regExp, regexString, } from '../../foundation.js';
    ...
    describe('include an edit wizard that', () => {
        describe('for Edition 1 projects', () => {
            ...
            describe('contains an input to edit P element of type IP', () => {
                ...
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(ipV4(), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
                it('does not allow to edit for invalid input', async () => await fc.assert(fc.asyncProperty(invertedRegex(regExp.IPv4), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
            ...
            describe('contains an input to edit P element of type OSI-TSEL', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(regexString(regExp.OSI, 1, 8), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
                it('does not allow to edit for invalid input', async () => await fc.assert(fc.asyncProperty(invertedRegex(regExp.OSI), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.false;
                })));
            ...
            describe('contains an input to edit P element of type OSI-SSEL', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(regexString(regExp.OSI, 1, 16), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
            ...
            describe('contains an input to edit P element of type OSI-AP-Title', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(regexString(regExp.OSIAPi, 1), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
                it('does not allow to edit for invalid input', async () => await fc.assert(fc.asyncProperty(invertedRegex(regExp.OSIAPi), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.false;
                })));
            ...
            describe('contains an input to edit P element of type OSI-AP-Invoke', () => {
                beforeEach(async () => {
                    ...
                    if (input && input.maybeValue === null)
                        await input.nullSwitch?.click();
                });
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(regexString(regExp.OSIid, 1, 5), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
                it('does not allow to edit for invalid input', async () => await fc.assert(fc.asyncProperty(invertedRegex(regExp.OSIid), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.false;
                })));
            ...
            describe('contains an input to edit P element of type OSI-NSAP', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(regexString(regExp.OSI, 1, 40), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
            ...
            describe('contains an input to edit P element of type VLAN-ID', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(regexString(regExp.OSI, 3, 3), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
            ...
            describe('contains an input to edit P element of type VLAN-PRIORITY', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(regexString(/^[0-7]$/), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
                it('does not allow to edit for invalid input', async () => await fc.assert(fc.asyncProperty(invertedRegex(/^[0-7]$/), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.false;
                })));
        ...
        describe('for Edition 2 projects', () => {
            ...
            describe('contains an input to edit P element of type SNTP-Port', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(nat({ max: 65535 }).map(num => `${num}`), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
                it('does not allow to edit for invalid input', async () => await fc.assert(fc.asyncProperty(invertedRegex(/^[0-9]*$/), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.false;
                })));
            ...
            describe('contains an input to edit P element of type DNSName', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(regexString(/^\S*$/, 1), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
            ...
            describe('contains an input to edit P element of type C37-118-IP-Port', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(integer({ min: 1025, max: 65535 }).map(num => `${num}`), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
        ...
        describe('for Edition 2.1 projects', () => {
            ...
            describe('contains an input to edit P element of type IPv6', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(ipV6(), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
                it('does not allow to edit for invalid input', async () => await fc.assert(fc.asyncProperty(invertedRegex(regExp.IPv6), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.false;
                })));
            ...
            describe('contains an input to edit P element of type IPv6-SUBNET', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(ipV6SubNet(), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
            ...
            describe('contains an input to edit P element of type IPv6FlowLabel', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(fc.hexaString({ minLength: 1, maxLength: 5 }), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
                it('does not allow to edit for invalid input', async () => await fc.assert(fc.asyncProperty(invertedRegex(/^[0-9a-fA-F]{1,5}$/), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.false;
                })));
            ...
            describe('contains an input to edit P element of type IPv6ClassOfTraffic', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(nat({ max: 255 }).map(num => `${num}`), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
            ...
            describe('contains an input to edit P element of type IP-ClassOfTraffic', () => {
                ...
                it('is always rendered', () => expect(input).to.exist);
                it('allow to edit for valid input', async () => await fc.assert(fc.asyncProperty(regexString(regExp.OSI, 1, 2), async (testValue) => {
                    input.value = testValue;
                    await element.requestUpdate();
                    expect(input.checkValidity()).to.be.true;
                })));
...
//# sourceMappingURL=connectedap-pattern.test.js.map
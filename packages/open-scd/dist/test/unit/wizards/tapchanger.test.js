...
import { createTapChangerWizard, editTapChangerWizard, } from '../../../src/wizards/tapchanger.js';
describe('Wizards for SCL TapChanger element', () => {
    ...
    describe('define an edit wizard that', () => {
        beforeEach(async () => {
            const wizard = editTapChangerWizard(doc.querySelector('TapChanger[name="tapChComplet"]'));
    ...
    describe('define a create wizard that', () => {
        beforeEach(async () => {
            const wizard = createTapChangerWizard(doc.querySelector('TransformerWinding'));
            element.workflow.push(() => wizard);
            await element.requestUpdate();
            inputs = Array.from(element.wizardUI.inputs);
            primaryAction = (element.wizardUI.dialog?.querySelector('mwc-button[slot="primaryAction"]'));
...
//# sourceMappingURL=tapchanger.test.js.map
...
describe('wizard-checkbox', () => {
    ...
    describe('with no attribute set', () => {
        ...
        it('is enabled', () => expect(element.checkbox).to.have.property('disabled', false));
        it('is un-checked', () => expect(element.checkbox).to.have.property('checked', false));
    ...
    describe('with nullable set', () => {
        ...
        describe('with a null value', () => {
            ...
            it('has a disabled checkbox', () => expect(element.checkbox).to.have.property('disabled', true));
            it('is false per default', () => expect(element.checkbox).to.have.property('checked', false));
    ...
    describe('disabled', () => {
        beforeEach(async () => {
            element = await fixture(html `<wizard-checkbox
          value=${'true'}
          nullable
          disabled
        ></wizard-checkbox>`);
        ...
        it('disables checkbox', () => expect(element.checkbox).to.have.property('disabled', true));
...
//# sourceMappingURL=wizard-checkbox.test.js.map
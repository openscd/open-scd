    ...
    describe('with a document loaded containing SCL history items', () => {
        ...
        describe('testing createMessage function', () => {
            it('creates a message with two valid strings', () => {
                expect(plugin['createMessage']('string who', 'string why')).to.be.equal('string who : string why');
            });
            it('creates a message with one valid string or returns undefined', () => {
                expect(plugin['createMessage']('string who', null)).to.be.equal('string who');
                expect(plugin['createMessage'](null, 'string why')).to.be.equal('string why');
...
//# sourceMappingURL=SclHistory.test.js.map
...
describe('OSCD-Wizard', () => {
    ...
    it('starts out with an empty workflow', () => expect(element).property('workflow').to.be.empty);
    it('shows no wizard-dialog', async () => await expect(element).shadowDom.to.be.empty);
...
//# sourceMappingURL=Wizards.test.js.map
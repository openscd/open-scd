...
describe('Global SCL related functions including', () => {
    ...
    describe('a function that checks FCDA reference validity in IED that', () => {
        ...
        it('returns true for existing MMXU data reference', () => expect(existFcdaReference(fcda1, ied)).to.be.true);
        it('returns true for existing LLN0 data reference', () => expect(existFcdaReference(fcda2, ied)).to.be.true);
    });
});

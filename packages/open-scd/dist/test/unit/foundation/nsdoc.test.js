        ...
        describe('has an getDataDescription function', () => {
            ...
            describe('which for LN elements', () => {
                it('returns the title', async function () {
                    const ln = validSCL.querySelector('IED[name="IED1"] > AccessPoint[name="P1"] > Server > LDevice[inst="CircuitBreaker_CB1"] > LN0[lnClass="LLN0"]');
                ...
                it('returns the lnClass in case no title can be found', async function () {
                    const ln = validSCL.querySelector('IED[name="IED1"] > AccessPoint[name="P1"] > Server > LDevice[inst="CircuitBreaker_CB1"] > LN[lnClass="XCBR"]');
...
//# sourceMappingURL=nsdoc.test.js.map
...
import { appIdGenerator, mACAddressGenerator, } from '../../../src/foundation/generators.js';
describe('MAC-Address generator function', () => {
    let macGenerator;
    let doc;
    describe('for GSE elements', () => {
        beforeEach(() => {
            doc = new DOMParser().parseFromString(`<ConnectedAP>
        ...
        </ConnectedAP>`, 'application/xml');
            macGenerator = mACAddressGenerator(doc, 'GSE');
        });
        it('returns unique MAC-Address', () => expect(macGenerator()).to.equal('01-0C-CD-01-00-03'));
    ...
    describe('for SMV elements', () => {
        ...
        it('returns unique MAC-Address', () => expect(macGenerator()).to.equal('01-0C-CD-04-00-04'));
        it('always returns unique MAC-Address', () => {

...
describe('wizard-select', () => {
    ...
    beforeEach(async () => {
        ...
        >${items.map(item => html `<mwc-list-item value="${item}">${item}</mwc-list-item>`)}</wizard-select
      >`);
    });
    ...
    describe('disabled', () => {
      ...
      >`);
        ...
        it('disables select', () => expect(element).to.have.property('disabled', true));
...
//# sourceMappingURL=wizard-select.test.js.map
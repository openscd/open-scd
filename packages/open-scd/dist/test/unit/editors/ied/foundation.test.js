...
import { findDOTypeElement, findElement, findLogicaNodeElement, getInstanceDAElement, getValueElements, } from '../../../../src/editors/ied/foundation.js';
...
describe('ied-foundation', async () => {
    ...
    describe('getValueElements', async () => {
        ...
        let daiElement2;
        beforeEach(async () => {
            daiElement1 = validSCL.querySelector(':root > IED[name="IED2"] > AccessPoint[name="P1"] > Server > ' +
                'LDevice[inst="CircuitBreaker_CB1"] > LN[lnType="Dummy.XCBR1"] > DOI[name="Pos"]> DAI[name="ctlModel"]');
            daiElement2 = validSCL.querySelector(':root > IED[name="IED3"] > AccessPoint[name="P1"] > Server > ' +

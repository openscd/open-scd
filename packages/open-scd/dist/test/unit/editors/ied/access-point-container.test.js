...
describe('access-point-container', () => {
    ...
    describe('with Server Elements', () => {
        beforeEach(async () => {
            apElement = validSCL.querySelector('IED[name="IED1"] > AccessPoint[name="P1"]');
    ...
    describe('with LN Elements', () => {
        describe('and all LN Classes displayed', () => {
            beforeEach(async () => {
                apElement = validSCL.querySelector('IED[name="IED4"] > AccessPoint[name="P1"]');
                element = await fixture(html `<access-point-container
          .element="${apElement}"
          .selectedLNClasses="${getLNClasses(apElement)}"
        ></access-point-container>`);
...
//# sourceMappingURL=access-point-container.test.js.map
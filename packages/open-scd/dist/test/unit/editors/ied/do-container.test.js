...
describe('do-container', async () => {
    ...
    it('looks like the latest snapshot with a DO element.', async () => {
      ...
      .element=${validSCL.querySelector('DataTypeTemplates > LNodeType[id="Dummy.LLN0"] > DO[name="Mod"]')}
      .nsdoc=${nsdoc}
    ></do-container>`);
    ...
    it('looks like the latest snapshot with a SDO element.', async () => {
        element = await fixture(html `<do-container
      .element=${validSCL.querySelector('DataTypeTemplates > DOType[id="Dummy.LLN0.ExtendedMod"] > SDO[name="someSdo"]')}
      .nsdoc=${nsdoc}
    ></do-container>`);
        await expect(element).shadowDom.to.equalSnapshot();
    });
    ...
    describe('has a getDOElements function ', () => {
        it('which return the (S)DO containers underneath a given DO.', async () => {
            element = await fixture(html `<do-container
        .element=${validSCL.querySelector('DataTypeTemplates > LNodeType[id="Dummy.LLN0"] > DO[name="ExtendedMod"]')}
        .nsdoc=${nsdoc}
      ></do-container>`);
        ...
        it('which return the (S)DO containers underneath a given SDO.', async () => {
            element = await fixture(html `<do-container
        .element=${validSCL.querySelector('DataTypeTemplates > DOType[id="Dummy.LLN0.ExtendedMod"] > SDO[name="someOtherSdo"]')}
        .nsdoc=${nsdoc}
      ></do-container>`);
            const nestedDOs = element['getDOElements']();
            expect(nestedDOs).to.not.be.empty;
        ...
        it('which return an empty array if the DoType cannot be found', async () => {
            element = await fixture(html `<do-container
        .element=${validSCL.querySelector('DataTypeTemplates > DOType[id="Dummy.LLN0.Mod"] > SDO[name="sdoName2"]')}
        .nsdoc=${nsdoc}
      ></do-container>`);
            const nestedDOs = element['getDOElements']();
        ...
        it("which return an empty array if a DO doesn\t have child (S)DO's.", async () => {
            element = await fixture(html `<do-container
        .element=${validSCL.querySelector('DataTypeTemplates > DOType[id="someSdoType"] > SDO[name="anotherSdo"]')}
        .nsdoc=${nsdoc}
      ></do-container>`);
            const nestedDOs = element['getDOElements']();
            expect(nestedDOs).to.be.empty;
    ...
    describe('has a getDAElements function ', () => {
      ...
      ></do-container>`);
        ...
        it("which return an empty array if a DO doesn\t have child DA's.", async () => {
            element = await fixture(html `<do-container
        .element=${validSCL.querySelector('DataTypeTemplates > DOType[id="Dummy.LLN0.Mod"] > SDO[name="sdoName3"]')}
        .nsdoc=${nsdoc}
      ></do-container>`);
            const nestedDOs = element['getDOElements']();
            expect(nestedDOs).to.be.empty;
    ...
    describe('has a getInstanceDOElement function ', () => {
        it('which return a DOI when a DO has a valid instance element.', async () => {
            element = await fixture(html `<do-container
        .element=${validSCL.querySelector('DataTypeTemplates > LNodeType[id="Dummy.CSWIwithoutCtlModel"] > DO[name="Pos"]')}
        .instanceElement=${validSCL.querySelector('IED[name="IED1"] > AccessPoint[name="P1"] > Server > LDevice[inst="CircuitBreaker_CB1"] > LN[lnClass="CSWI"] > DOI[name="Pos"]')}
        .nsdoc=${nsdoc}
      ></do-container>`);
...
//# sourceMappingURL=do-container.test.js.map
...
describe('conducting-equipment-editor', () => {
    ...
    beforeEach(async () => {
        ...
        element = (await fixture(html `<conducting-equipment-editor
    ...
    describe('rendered as action icon', () => {
        ...
        it('triggers edit wizard for LNode element on action button click', async () => {
            (element.shadowRoot?.querySelector('mwc-fab[icon="account_tree"]')).click();
            await element.requestUpdate();
...
//# sourceMappingURL=conducting-equipment-editor.test.js.map
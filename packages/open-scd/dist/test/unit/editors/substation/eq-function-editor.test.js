...
describe('web component rendering EqFunction element', () => {
    ...
    describe('with complete attribute set and existing children', () => {
        beforeEach(async () => {
            element = (await fixture(html `<eq-function-editor
    ...
    describe('with existing LNode children', () => {
        beforeEach(async () => {
            element = (await fixture(html `<eq-function-editor
            .element=${doc.querySelector('ConductingEquipment[name="QB2"] EqFunction')}
          ></eq-function-editor>`));
        });
        it('looks like the latest snapshot', async () => await expect(element).shadowDom.to.equalSnapshot());
    });
...
//# sourceMappingURL=eq-function-editor.test.js.map
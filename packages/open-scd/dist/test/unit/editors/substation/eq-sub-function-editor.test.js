...
describe('web component rendering EqSubFunction element', () => {
    ...
    describe('with complete attribute set and existing children', () => {
        beforeEach(async () => {
            element = (await fixture(html `<eq-sub-function-editor
    ...
    describe('with existing LNode children', () => {
        beforeEach(async () => {
            element = (await fixture(html `<eq-sub-function-editor
            .element=${doc.querySelector('ConductingEquipment[name="QB1"] EqSubFunction')}
          ></eq-sub-function-editor>`));
        });
        it('looks like the latest snapshot', async () => await expect(element).shadowDom.to.equalSnapshot());
    });
    describe('with general-equipment children', () => {
        ...
        it('with showfunctions false looks like the latest snapshot', async () => await expect(element).shadowDom.to.equalSnapshot());
...
//# sourceMappingURL=eq-sub-function-editor.test.js.map
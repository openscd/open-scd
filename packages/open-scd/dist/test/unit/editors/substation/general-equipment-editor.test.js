...
describe('Editor web component for GeneralEquipment SCL element', () => {
    ...
    beforeEach(async () => {
        ...
        element = await fixture(html `<general-equipment-editor
        .doc=${doc}
    ...
    describe('rendered as action pane', () => {
        ...
        it('look like the latest snapshot', async () => await expect(element).shadowDom.to.equalSnapshot());
    });
});
//# sourceMappingURL=general-equipment-editor.test.js.map
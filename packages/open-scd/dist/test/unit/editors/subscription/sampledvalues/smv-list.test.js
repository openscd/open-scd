...
describe('smv-list', () => {
    ...
    it('triggers a newSmvSelectEvent when a list item is clicked', () => {
        ...
        listItem.click();
        expect(selectEvent).to.have.be.calledOnce;
        expect(selectEvent.args[0][0].detail.smvControl).to.eql(validSCL.querySelector('IED[name="IED3"] > AccessPoint > Server > LDevice > LN0 > SampledValueControl[name="MSVCB01"]'));
        expect(selectEvent.args[0][0].detail.dataset).to.eql(validSCL.querySelector('IED[name="IED3"] > AccessPoint > Server > LDevice > LN0 > DataSet[name="PhsMeas1"]'));
    });
});
//# sourceMappingURL=smv-list.test.js.map
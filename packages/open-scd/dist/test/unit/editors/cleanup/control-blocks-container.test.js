...
describe('Cleanup: Control Blocks Container', () => {
    let element;
    beforeEach(async () => {
        element = await fixture(html `<cleanup-control-blocks></cleanup-control-blocks>`);
    });
    ...
    describe('With a test file loaded', () => {
        ...
        beforeEach(async () => {
            ...
            element = await fixture(html `<cleanup-control-blocks .doc="${doc}"></cleanup-control-blocks>`);

...
import { getRelativeCoordinates, isBusBar, getConnectedTerminals, calculateConnectivityNodeCoordinates, getCommonParentElement, } from '../../../../src/editors/singlelinediagram/foundation.js';
...
describe('Single Line Diagram foundation', () => {
    ...
    describe('defines a getInstance function that', () => {
        it('returns the correct instance for an element.', () => {
            const element = doc.querySelector('IED[name="IED1"] > AccessPoint[name="P1"] > Server > LDevice[name="LDeviceA"]');

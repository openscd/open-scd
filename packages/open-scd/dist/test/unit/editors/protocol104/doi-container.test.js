...
describe('doi-104-container -', () => {
    ...
    describe('DOI with simple Address Element', () => {
        beforeEach(async () => {
            ...
            element = await fixture(html `<doi-104-container .element="${doiElement}"></doi-104-container>`);
        ...
        it('getAddressElements will return a list', () => {
            ...
            expect(get104DetailsLine(dai, addresses[0])).to.be.equal('casdu: 201, ioa: 2, ti: 58');
        });
...
//# sourceMappingURL=doi-container.test.js.map
...
describe('ied-104-container -', () => {
    ...
    describe('IED with DAI Elements', () => {
        beforeEach(async () => {
            ...
            element = await fixture(html `<ied-104-container .element="${iedElement}"></ied-104-container>`);
        ...
        it('getDoiElements will return a list which is alphabetically ordered', () => {
            ...
            expect(getFullPath(dois[1], 'IED')).to.be.equal('AP1 / LD0 / PPRE-GGIO-2 / Beh');
        });
...
//# sourceMappingURL=ied-container.test.js.map
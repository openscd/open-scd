...
describe('Editor for SampledValueControl element its referenced elements', () => {
    ...
    describe('with deprecated multicast attribute set to false', () => {
        beforeEach(async () => {
            const sampledValueControl = doc.querySelector('SampledValueControl[multicast="false"]');
            element = await fixture(html `<sampled-value-control-element-editor
    ...
    describe('with multicast SampledValueControl', () => {
        beforeEach(async () => {
            const SampledValueControl = doc.querySelector('SampledValueControl[multicast="true"]');
            element = await fixture(html `<sampled-value-control-element-editor
          .element=${SampledValueControl}
        ></sampled-value-control-element-editor>`);
        });
...
//# sourceMappingURL=sampled-value-control-element-editor.test.js.map
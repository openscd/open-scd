...
describe('connectedap wizarding editing integration', () => {
    ...
    `;
        ...
        const vlanId = element.wizardUI.shadowRoot.querySelector('wizard-textfield[label="VLAN-ID"]');
        const vlanPriority = element.wizardUI.shadowRoot.querySelector('wizard-textfield[label="VLAN-PRIORITY"]');
        expect(vlanId.hasAttribute('disabled')).to.be.true;
        expect(vlanPriority.hasAttribute('disabled')).to.be.true;
    });
});
//# sourceMappingURL=connectedap-wizarding-editing-integration.test.js.map
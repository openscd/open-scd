...
describe('FCDA editing wizarding integration', () => {
    ...
    describe('with a specific path', () => {
        ...
        it('adds a new FCDA on primary action', async () => {
            expect(doc.querySelector('DataSet > FCDA[ldInst="CircuitBreaker_CB1"]' +
    ...
    describe('with a more complex path including SDOs and BDAs', () => {
        ...
        it('adds a new FCDA on primary action', async () => {
            expect(doc.querySelector('DataSet > FCDA[ldInst="Meas"]' +
...
//# sourceMappingURL=fcda-wizarding-editing-integration.test.js.map
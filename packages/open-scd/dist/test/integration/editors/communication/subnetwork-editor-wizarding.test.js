...
describe('subnetwork-editor wizarding integration', () => {
    describe('edit/add Subnetwork wizard', () => {
        ...
        describe('the third input element', () => {
            ...
            it('edits only for valid inputs', async () => {
                await fc.assert(fc.asyncProperty(regexString(regExp.desc, 1), async (type) => {
        ...
        describe('the fourth input element', () => {
            ...
            it('edits only for valid inputs', async () => {
                await fc.assert(fc.asyncProperty(regexString(regExp.decimal), async (BitRate) => {
            ...
            it('rejects edition for invalid inputs', async () => {
                await fc.assert(fc.asyncProperty(regexString(inverseRegExp.decimal, 1), async (BitRate) => {
                    parent.wizardUI.inputs[3].value = BitRate;
                    await parent.updateComplete;
...
//# sourceMappingURL=subnetwork-editor-wizarding.test.js.map
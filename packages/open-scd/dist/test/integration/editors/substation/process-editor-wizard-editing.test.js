...
describe('process-editor wizarding editing integration', () => {
    ...
    describe('edit wizard', () => {
        ...
        it('changes name attribute on primary action', async () => {
            ...
            primaryAction.click();
            await parent.updateComplete;
            expect(doc.querySelector('Process')?.getAttribute('name')).to.equal('newName');
        });
        ...
        it('changes type attribute on primary action', async () => {
            ...
            expect(doc
                .querySelector('Process[name="ProcessGenConduct"]')
                ?.getAttribute('type')).to.equal('newType');
        });
...
//# sourceMappingURL=process-editor-wizard-editing.test.js.map
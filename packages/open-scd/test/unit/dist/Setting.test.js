...
require("./mock-setter.js");
var Setting_js_1 = require("../../src/Setting.js");
describe('SettingElement', function () {
    var element;
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    localStorage.clear();
                    return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<mock-setter></mock-setter>"], ["<mock-setter></mock-setter>"]))))];
                case 1:
                    element = (_a.sent());
                    return [2 /*return*/];
            }
    ...
    it('initially has default settings', function () {
        return testing_1.expect(element).to.have.deep.property('settings', Setting_js_1.defaults);
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    testing_1.expect(element).to.not.have.deep.property('settings', Setting_js_1.defaults);
                    (element.settingsUI.querySelector('mwc-button[dialogAction="reset"]')).click();
                    testing_1.expect(element).to.have.deep.property('settings', Setting_js_1.defaults);
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    testing_1.expect(element).shadowDom.to.equalSnapshot();
                    return [2 /*return*/];
            }
        });
    }); });

...
require("./mock-plugger.js");
describe('PluggingElement', function () {
    var element;
    var doc;
    var docName = 'testDoc';
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    doc = _a.sent();
                    return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<mock-plugger .doc=", " .docName=", "></mock-plugger>"], ["<mock-plugger .doc=", " .docName=", "></mock-plugger>"])), doc, docName))];
                case 2:
                    element = (_a.sent());
    ...
    it('has docs property', function () {
        var docs = {};
        docs[docName] = doc;
        testing_1.expect(element).to.have.property('docs', docs);
    });

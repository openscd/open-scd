...
snapshots[
  'Wizards for SCL TransformerWinding element define an edit wizard that looks like the the latest snapshot'
] = `<mwc-dialog
  defaultaction="next"
...
snapshots[
  'Wizards for SCL TransformerWinding element define a create wizard that looks like the the latest snapshot'
] = `<mwc-dialog
  defaultaction="next"

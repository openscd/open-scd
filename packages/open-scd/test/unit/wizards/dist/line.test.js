...
var line_js_1 = require("../../../src/wizards/line.js");
describe('Wizards for SCL Line element', function () {
    var doc;
    var element;
    var inputs;
    var primaryAction;
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    element = _a.sent();
                    return [4 /*yield*/, fetch('/test/testfiles/editors/substation/Line.scd')
    ...
    describe('define an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = line_js_1.editLineWizard(doc.querySelector('Line[name="Berlin"]'));
        ...
        it('allows to create non required attribute type', function () { return __awaiter(void 0, void 0, void 0, function () {
            var action, editAction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isReplace);
                        editAction = action;
                        testing_1.expect(editAction["new"].element).to.have.attribute('type', 'someNonEmptyType');
                        return [2 /*return*/];
                }
            });
        }); });
        it('allows to create non required attribute nomFreq', function () { return __awaiter(void 0, void 0, void 0, function () {
            var action, editAction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isReplace);
                        editAction = action;
                        testing_1.expect(editAction["new"].element).to.have.attribute('nomFreq', '50');
                        return [2 /*return*/];
                }
            });
        }); });
        it('allows to create non required attribute numPhases', function () { return __awaiter(void 0, void 0, void 0, function () {
            var action, editAction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isReplace);
                        editAction = action;
                        testing_1.expect(editAction["new"].element).to.have.attribute('numPhases', '3');
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('define a create wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = line_js_1.createLineWizard(doc.querySelector('Line[name="Berlin"]'));
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _b.sent();
        ...
        it('allows to create name and non required attribute type', function () { return __awaiter(void 0, void 0, void 0, function () {
            var action, createAction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isCreate);
                        createAction = action;
                        testing_1.expect(createAction["new"].element).to.have.attribute('type', 'someNonEmptyType');
                        return [2 /*return*/];
                }
            });
        }); });
        it('allows to create name and non required attribute nomFreq', function () { return __awaiter(void 0, void 0, void 0, function () {
            var action, createAction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isCreate);
                        createAction = action;
                        testing_1.expect(createAction["new"].element).to.have.attribute('nomFreq', '50');
                        return [2 /*return*/];
                }
            });
        }); });
        it('allows to create name and non required attribute numPhases', function () { return __awaiter(void 0, void 0, void 0, function () {
            var action, createAction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isCreate);
                        createAction = action;
                        testing_1.expect(createAction["new"].element).to.have.attribute('numPhases', '3');
                        return [2 /*return*/];
                }
            });
        }); });

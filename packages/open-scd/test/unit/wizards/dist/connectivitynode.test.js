...
var connectivitynode_js_1 = require("../../../src/wizards/connectivitynode.js");
describe('Wizards for SCL element ConnectivityNode', function () {
    var doc;
    var element;
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    element = _a.sent();
                    return [4 /*yield*/, fetch('/test/testfiles/valid2007B4withSubstationXY.scd')
                            .then(function (response) { return response.text(); })
                            .then(function (str) { return new DOMParser().parseFromString(str, 'application/xml'); })];
                case 2:
                    doc = _a.sent();
                    wizard = connectivitynode_js_1.editConnectivityNodeWizard(doc.querySelector('ConnectivityNode'));

...
var powertransformer_js_1 = require("../../../src/wizards/powertransformer.js");
var test_support_js_1 = require("./test-support.js");
describe('Wizards for SCL element Power Transformer', function () {
    var doc;
    var powerTransformer;
    var element;
    var inputs;
    describe('edit existing Power Transformer', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        element = _a.sent();
                        wizard = powertransformer_js_1.editPowerTransformerWizard(powerTransformer);
        ...
        it('update name should be updated in document', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, test_support_js_1.setWizardTextFieldValue(inputs[0], 'OtherTA1')];
                        case 1:
                            _a.sent();
                            updateAction = test_support_js_1.executeWizardReplaceAction(actions_js_1.replaceNamingAction(powerTransformer), element.wizardUI, inputs);
                            testing_1.expect(updateAction.old.element).to.have.attribute('name', 'TA1');
                            testing_1.expect(updateAction["new"].element).to.have.attribute('name', 'OtherTA1');
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('when no fields changed there will be no update action', function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    test_support_js_1.expectWizardNoUpdateAction(actions_js_1.replaceNamingAction(powerTransformer), element.wizardUI, inputs);
                    return [2 /*return*/];
                });
            });
        });
    ...
    describe('add new Power Transformer', function () {
        var parent;
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            var wizard;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        element = _a.sent();
                        wizard = powertransformer_js_1.createPowerTransformerWizard(parent);
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 3:
                        _a.sent();
        ...
        it('create new Power Transformer', function () {
            return __awaiter(this, void 0, void 0, function () {
                var createAC;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, test_support_js_1.setWizardTextFieldValue(inputs[0], 'NewTA1')];
                        case 1:
                            _a.sent();
                            createAC = test_support_js_1.executeWizardCreateAction(powertransformer_js_1.createAction(parent), element.wizardUI, inputs);
                            testing_1.expect(createAC["new"].element).to.have.attribute('name', 'NewTA1');
                            return [2 /*return*/];
                    }
                });
            });

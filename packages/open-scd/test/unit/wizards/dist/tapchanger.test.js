...
var tapchanger_js_1 = require("../../../src/wizards/tapchanger.js");
describe('Wizards for SCL TapChanger element', function () {
    var doc;
    var element;
    var inputs;
    var primaryAction;
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    element = _a.sent();
                    return [4 /*yield*/, fetch('/test/testfiles/editors/substation/TapChanger.scd')
    ...
    describe('define an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = tapchanger_js_1.editTapChangerWizard(doc.querySelector('TapChanger[name="tapChComplet"]'));
        ...
        it('allows to unset non required attribute virtual', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isReplace);
                        editAction = action;
                        testing_1.expect(editAction["new"].element).to.have.attribute('virtual', 'false');
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('define a create wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = tapchanger_js_1.createTapChangerWizard(doc.querySelector('TransformerWinding'));
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _b.sent();

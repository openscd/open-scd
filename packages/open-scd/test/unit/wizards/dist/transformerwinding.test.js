...
var transformerWinding_1 = require("../../../src/wizards/transformerWinding");
    ...
    describe('define an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = transformerWinding_1.editTransformerWindingWizard(doc.querySelector('TransformerWinding'));
    ...
    describe('define a create wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = transformerWinding_1.createTransformerWindingWizard(doc.querySelector('PowerTransformer'));
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _b.sent();

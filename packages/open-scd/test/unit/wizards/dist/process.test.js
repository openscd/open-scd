...
var process_js_1 = require("../../../src/wizards/process.js");
describe('Wizards for SCL Process element', function () {
    var doc;
    var element;
    var inputs;
    var primaryAction;
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    element = _a.sent();
                    return [4 /*yield*/, fetch('/test/testfiles/editors/substation/Process.scd')
    ...
    describe('define an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = process_js_1.editProcessWizard(doc.querySelector('Process[name="ProcessGenConduct"]'));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isReplace);
                        editAction = action;
                        testing_1.expect(editAction["new"].element).to.have.attribute('desc', 'someDesc');
                        return [2 /*return*/];
                }
            });
        }); });
        it('allows to create non required attribute type', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        (_a = inputs[2].nullSwitch) === null || _a === void 0 ? void 0 : _a.click();
    ...
    describe('define a create wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = process_js_1.createProcessWizard(doc.querySelector('Process[name="ProcessGenConduct"]'));
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _b.sent();

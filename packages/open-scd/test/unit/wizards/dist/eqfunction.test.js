...
var eqfunction_js_1 = require("../../../src/wizards/eqfunction.js");
describe('Wizards for SCL EqFunction element', function () {
    var doc;
    var element;
    var inputs;
    var primaryAction;
    ...
    describe('define an create wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = eqfunction_js_1.createEqFunctionWizard(doc.querySelector('ConductingEquipment'));
    ...
    describe('define an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = eqfunction_js_1.editEqFunctionWizard(doc.querySelector('PowerTransformer[name="myPtr3"] > EqFunction[name="myEqFuncQB3"]'));
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _b.sent();

...
var subequipment_js_1 = require("../../../src/wizards/subequipment.js");
describe('Wizards for SCL SubEquipment element', function () {
    var doc;
    var element;
    var inputs;
    var primaryAction;
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    element = _a.sent();
                    return [4 /*yield*/, fetch('test/testfiles/SubEquipment.scd')
    ...
    describe('define an create wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = subequipment_js_1.createSubEquipmentWizard(doc.querySelector('SubEquipment'));
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        (_b = virtualCheckbox.nullSwitch) === null || _b === void 0 ? void 0 : _b.click();
    ...
    describe('define an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = subequipment_js_1.editSubEquipmentWizard(doc.querySelector('SubEquipment'));
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _b.sent();
        ...
        it('triggers simple replace action updating phase attribute', function () { return __awaiter(void 0, void 0, void 0, function () {
            var action, createAction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isReplace);
                        createAction = action;
                        testing_1.expect(createAction["new"].element).to.have.attribute('phase', 'AB');
                        return [2 /*return*/];
                }
            });
        }); });
        it('triggers simple replace action updating virtual attribute', function () { return __awaiter(void 0, void 0, void 0, function () {
            var virtualCheckbox, action, createAction;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {

...
var function_js_1 = require("../../../src/wizards/function.js");
    ...
    describe('define an create wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = function_js_1.createFunctionWizard(doc.querySelector('Substation'));
    ...
    describe('define an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = function_js_1.editFunctionWizard(doc.querySelector('Bay[name="COUPLING_BAY"] > Function[name="bayName"]'));
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _b.sent();

...
var eqsubfunction_js_1 = require("../../../src/wizards/eqsubfunction.js");
describe('Wizards for SCL EqSubFunction element', function () {
    var doc;
    var element;
    var inputs;
    var primaryAction;
    ...
    describe('define an create wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = eqsubfunction_js_1.createEqSubFunctionWizard(doc.querySelector('EqFunction'));
    ...
    describe('define an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = eqsubfunction_js_1.editEqSubFunctionWizard(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqSubSubFunction"]'));
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _b.sent();

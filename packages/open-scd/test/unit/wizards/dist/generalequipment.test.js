...
var generalEquipment_js_1 = require("../../../src/wizards/generalEquipment.js");
describe('Wizards for SCL GeneralEquipment element', function () {
    var doc;
    var element;
    var inputs;
    var primaryAction;
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    element = _a.sent();
                    return [4 /*yield*/, fetch('/test/testfiles/editors/substation/generalequipment.scd')
    ...
    describe('define an create wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = generalEquipment_js_1.createGeneralEquipmentWizard(doc.querySelector('Substation'));
        ...
        it('allows to create required attributes name and type', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        testing_1.expect(createAction["new"].element).to.have.attribute('type', 'AXN');
                        testing_1.expect(createAction["new"].element).to.not.have.attribute('desc');
                        return [2 /*return*/];
                }
            });
        }); });
        it('does not accept invalid type attribute', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        inputs[0].value = 'someNonEmptyName';
        ...
        it('allows to create non required attributes desc', function () { return __awaiter(void 0, void 0, void 0, function () {
            var action, createAction;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('allows to create non required attributes virtual', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        (_a = inputs[1].nullSwitch) === null || _a === void 0 ? void 0 : _a.click();
                        inputs[1].value = 'SomeDesc';
                        virtualCheckbox = ((_b = element.wizardUI.dialog) === null || _b === void 0 ? void 0 : _b.querySelector('wizard-checkbox[label="virtual"]'));
    ...
    describe('define an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wizard = generalEquipment_js_1.editGeneralEquipmentWizard(doc.querySelector('GeneralEquipment'));
                        element.workflow.push(function () { return wizard; });
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _b.sent();
        ...
        it('does not accept empty type attribute', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        inputs[2].value = '';
        ...
        it('allows to create type attribute', function () { return __awaiter(void 0, void 0, void 0, function () {
            var action, editAction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        testing_1.expect(action).to.satisfy(foundation_js_1.isReplace);
                        editAction = action;
                        testing_1.expect(editAction["new"].element).to.have.attribute('type', 'BAT');
                        return [2 /*return*/];
                }
            });
        }); });

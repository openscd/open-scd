...
describe('Wizards for preparing 104 Address Creation', function () {
    ...
    describe('show prepare 104 Address creation with enc cdc value', function () {
        var monitorTi;
        var controlTi;
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            var cdc;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prepareWizard('IED[name="B1"] LN[lnType="SE_GGIO_SET_V002"]', 'Mod')];
                    case 1:
                        _a.sent();
                        cdc = element.wizardUI.dialog.querySelector('wizard-textfield[label="Common Data Class"]');
                        testing_1.expect(cdc).to.exist;
                        testing_1.expect(cdc.maybeValue).to.equal('ENC');
        ...
        it('controlTi should change to correct value when selecting monitorTi', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        monitorTi.value = '30';
                    ...
                    case 1:
                        _a.sent();
                        testing_1.expect(controlTi.maybeValue).to.equal('58');
                        monitorTi.value = '35';
                        return [4 /*yield*/, element.requestUpdate()];
                    case 2:
                        _a.sent();
                        testing_1.expect(controlTi.maybeValue).to.equal('62');
                        return [2 /*return*/];
                }
            });
        }); });
        it('monitorTi should change to correct value when selecting controlTi', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        controlTi.value = '58';
                    ...
                    case 1:
                        _a.sent();
                        testing_1.expect(monitorTi.maybeValue).to.equal('30');
                        controlTi.value = '62';
                        return [4 /*yield*/, element.requestUpdate()];
                    case 2:
                        _a.sent();
                        testing_1.expect(monitorTi.maybeValue).to.equal('35');
                        return [2 /*return*/];
                }
            });
        }); });
    });
    describe('show prepare 104 Address creation with mapped cdc value', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prepareWizard('IED[name="B1"] LN[lnType="SE_MMXU_SET_V001"]', 'PPV')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('show prepare 104 Address creation (single monitor TI and single control TI with CtlModel)', function () {
        ...
        it('when processing the request with Check Selected, the expected Create Actions are returned', function () { return __awaiter(void 0, void 0, void 0, function () {
            var switchElement, actions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        switchElement = element.wizardUI.dialog.querySelector("mwc-switch[id=\"controlCheck\"]");
                        switchElement.checked = true;
                        return [4 /*yield*/, element.requestUpdate()];
                    case 1:
                        _a.sent();
                        actions = createAddresses_js_1.createAddressesAction(lnElement, doElement, true)(inputs, element.wizardUI);

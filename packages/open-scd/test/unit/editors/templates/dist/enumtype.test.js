...
var enumtype_wizard_js_1 = require("../../../../src/editors/templates/enumtype-wizard.js");
describe('wizards for EnumType element', function () {
    var doc;
    var element;
    var inputs;
    var input;
    ...
    describe('include an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        doc = _b.sent();
                        wizard = enumtype_wizard_js_1.eNumTypeEditWizard(foundation_js_1.identity(doc.querySelector('EnumType')), doc);
        ...
        describe('allows to edit id attribute', function () {
            ...
            it('that edits the id attribute of EnumType', function () {
                input.value = 'someTestId';
                primaryAction.click();
            ...
            it('that edits all referenced lnType attribute as well', function () {
                ...
                var numReferences = doc.querySelectorAll("DOType > DA[type=\"" + oldId + "\"], DAType > BDA[type=\"" + oldId + "\"]").length;
                input.value = 'someTestId';
                primaryAction.click();
                var complexAction = (actionEvent.args[0][0].detail.action);
                var actions = complexAction.actions;

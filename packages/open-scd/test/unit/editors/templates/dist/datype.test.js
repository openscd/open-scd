...
var datype_wizards_js_1 = require("../../../../src/editors/templates/datype-wizards.js");
describe('wizards for DAType element', function () {
    var doc;
    var element;
    var inputs;
    var input;
    ...
    describe('include an edit wizard that', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        doc = _b.sent();
                        wizard = datype_wizards_js_1.editDaTypeWizard(foundation_js_1.identity(doc.querySelector('DAType')), doc);
        ...
        describe('allows to edit id attribute', function () {
            ...
            it('that edits the id attribute of DAType', function () {
                input.value = 'someTestId';
                primaryAction.click();

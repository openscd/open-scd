...
var powertransformer_js_1 = require("../../../../../src/editors/singlelinediagram/wizards/powertransformer.js");
var foundation_js_1 = require("../../../../../src/editors/singlelinediagram/wizards/foundation.js");
describe('Wizards for SCL element Power Transformer (X/Y)', function () {
    var doc;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        updateAction = test_support_js_1.executeWizardReplaceAction(foundation_js_1.updateNamingAndCoordinatesAction(powerTransformer), element.wizardUI, inputs);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        updateAction = test_support_js_1.executeWizardReplaceAction(foundation_js_1.updateNamingAndCoordinatesAction(powerTransformer), element.wizardUI, inputs);
                        testing_1.expect(updateAction.old.element).to.have.attribute('sxy:y', '9');
    ...
    it('when no fields changed there will be no update action', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                test_support_js_1.expectWizardNoUpdateAction(foundation_js_1.updateNamingAndCoordinatesAction(powerTransformer), element.wizardUI, inputs);
                return [2 /*return*/];
            });
        });
    });

...
var conductingequipment_js_1 = require("../../../../../src/editors/singlelinediagram/wizards/conductingequipment.js");
var foundation_js_1 = require("../../../../../src/editors/singlelinediagram/wizards/foundation.js");
describe('Wizards for SCL element Conducting Equipment (X/Y)', function () {
    var doc;
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    element = _a.sent();
                    wizard = conductingequipment_js_1.editConductingEquipmentWizard(conductingEquipment);
    ...
    it('update name should be updated in document', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, test_support_js_1.setWizardTextFieldValue(inputs[1], 'OtherQB1')];
                    case 1:
                        _a.sent();
                        updateAction = test_support_js_1.executeWizardReplaceAction(foundation_js_1.updateNamingAndCoordinatesAction(conductingEquipment), element.wizardUI, inputs);
                        testing_1.expect(updateAction.old.element).to.have.attribute('name', 'QB1');
                        testing_1.expect(updateAction["new"].element).to.have.attribute('name', 'OtherQB1');
                        return [2 /*return*/];
                }
            });
        });
    ...
    it('update description should be updated in document', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, test_support_js_1.setWizardTextFieldValue(inputs[2], 'Some description')];
                    case 1:
                        _a.sent();
                        updateAction = test_support_js_1.executeWizardReplaceAction(foundation_js_1.updateNamingAndCoordinatesAction(conductingEquipment), element.wizardUI, inputs);
    ...
    it('update X-Coordinate should be updated in document', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, test_support_js_1.setWizardTextFieldValue(inputs[3], '4')];
                    case 1:
                        _a.sent();
                        updateAction = test_support_js_1.executeWizardReplaceAction(foundation_js_1.updateNamingAndCoordinatesAction(conductingEquipment), element.wizardUI, inputs);
    ...
    it('update Y-Coordinate should be updated in document', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, test_support_js_1.setWizardTextFieldValue(inputs[4], '5')];
                    case 1:
                        _a.sent();
                        updateAction = test_support_js_1.executeWizardReplaceAction(foundation_js_1.updateNamingAndCoordinatesAction(conductingEquipment), element.wizardUI, inputs);
    ...
    it('clear Y-Coordinate should be updated in document', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, test_support_js_1.setWizardTextFieldValue(inputs[4], null)];
                    case 1:
                        _a.sent();
                        updateAction = test_support_js_1.executeWizardReplaceAction(foundation_js_1.updateNamingAndCoordinatesAction(conductingEquipment), element.wizardUI, inputs);
                        testing_1.expect(updateAction.old.element).to.have.attribute('sxy:y', '1');
    ...
    it('when no fields changed there will be no update action', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                test_support_js_1.expectWizardNoUpdateAction(foundation_js_1.updateNamingAndCoordinatesAction(conductingEquipment), element.wizardUI, inputs);
                return [2 /*return*/];
            });
        });
    });

...
describe('Cleanup: Control Blocks Container', function () {
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<cleanup-control-blocks></cleanup-control-blocks>"], ["<cleanup-control-blocks></cleanup-control-blocks>"]))))];
                case 1:
                    element = _a.sent();
                    return [2 /*return*/];
            }
    ...
    describe('With a test file loaded', function () {
        ...
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        doc = _a.sent();
                        return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["<cleanup-control-blocks .doc=\"", "\"></cleanup-control-blocks>"], ["<cleanup-control-blocks .doc=\"", "\"></cleanup-control-blocks>"])), doc))];
                    case 2:
                        element = _a.sent();
        ...
        it('creates correct number of checkboxes for the expected unreferenced control blocks', function () {
            testing_1.expect(Array.from(element.unreferencedControls).length).to.equal(5);
        });
        ...
        it('after selecting and deselecting an item the remove button is disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            var firstCheckListItem;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('after clicking select all the button is not disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            var checkbox;
            var _a;

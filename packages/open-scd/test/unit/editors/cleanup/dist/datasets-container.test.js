...
describe('Cleanup: Datasets Container', function () {
    ...
    describe('with a test file loaded', function () {
        ...
        it('creates correct number of checkboxes for the expected unreferenced datasets', function () {
            testing_1.expect(Array.from(element.dataSetItems).length).to.equal(2);
        });
        it('has the remove button disabled by default', function () {
            testing_1.expect(element.cleanupButton).to.have.property('disabled', true);
        });
        it('has the remove button enabled after selecting an item', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        firstCheckListItem = element.dataSetItems[0];
                        return [4 /*yield*/, firstCheckListItem.click()];
                    case 1:
                        _a.sent();
                        testing_1.expect(element.cleanupButton).to.have.property('disabled', false);
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('after clicking select all the button is not disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, ((_a = element.dataSetList) === null || _a === void 0 ? void 0 : _a.layout())];
                    case 2:
                        _b.sent();
                        testing_1.expect(element.cleanupButton).to.have.property('disabled', false);
                        return [2 /*return*/];
        ...
        it('after clicking select all twice the button is disabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            var checkbox;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {

...
describe('dataset wizards', function () {
    ...
    describe('editDataSetWizard', function () {
        var primaryAction;
        var nameField;
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            var wizard;
        ...
        it('allows to change data set attributes', function () {
            testing_1.expect(doc.querySelector('IED[name="IED2"] DataSet[name="myNewDataSet"]'));
            nameField.value = 'myNewDataSetName';
            primaryAction.click();
            testing_1.expect(doc.querySelector('IED[name="IED2"] DataSet[name="myNewDataSetName"]'));
        });
    });
});

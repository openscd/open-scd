...
describe('gse wizarding editing integration', function () {
    var doc;
    var element;
    ...
    describe('editGseWizard', function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, minTimeField.updateComplete];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
        ...
        it('allows to edit GSE attributes', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        testing_1.expect((_b = (_a = doc
                            .querySelector('GSE[ldInst="CircuitBreaker_CB1"][cbName="GCB"] > MinTime')) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.trim()).to.equal('10');
                        minTimeField.value = '56';
                        primaryAction.click();
                        return [4 /*yield*/, element.updateComplete];
                    case 1:
                        _e.sent();
                        testing_1.expect((_d = (_c = doc
                            .querySelector('GSE[ldInst="CircuitBreaker_CB1"][cbName="GCB"] > MinTime')) === null || _c === void 0 ? void 0 : _c.textContent) === null || _d === void 0 ? void 0 : _d.trim()).to.equal('56');
                        return [2 /*return*/];
                }
            });
        }); });

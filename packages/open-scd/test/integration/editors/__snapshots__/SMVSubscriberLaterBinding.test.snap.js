...
snapshots["SMV Subscribe Later Binding plugin when subscribing an available ExtRef then the lists are changed"] = 
`<section tabindex="0">
  <h1>
    Inputs available for selected data attribute
  </h1>
...
`;
/* end snapshot SMV Subscribe Later Binding plugin when subscribing an available ExtRef then the lists are changed */

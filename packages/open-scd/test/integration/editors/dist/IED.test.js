...
describe('IED Plugin', function () {
    if (customElements.get('ied-plugin') === undefined)
        customElements.define('ied-plugin', Wizarding_js_1.Wizarding(Editing_js_1.Editing(IED_js_1["default"])));
    var element;
    var nsdoc;
    describe('without a doc loaded', function () {
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<ied-plugin></ied-plugin>"], ["<ied-plugin></ied-plugin>"]))))];
                    case 1:
                        element = _a.sent();
            ...
            beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            nsdoc = _a.sent();
                            return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject([" <ied-plugin .doc=\"", "\" .nsdoc=\"", "\"></ied-plugin>"], [" <ied-plugin .doc=\"", "\" .nsdoc=\"", "\"></ied-plugin>"])), doc, nsdoc))];
                        case 3:
                            element = _a.sent();
                            return [4 /*yield*/, element.requestUpdate()];
                        case 4:
            ...
            beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            nsdoc = _a.sent();
                            return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<ied-plugin .doc=", " .nsdoc=", "></ied-plugin>"], ["<ied-plugin .doc=", " .nsdoc=", "></ied-plugin>"])), doc, nsdoc))];
                        case 3:
                            element = _a.sent();
                            return [4 /*yield*/, element.requestUpdate()];
                        case 4:
            ...
            it('Should open Services wizard', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            testing_1.expect(element.wizardUI).to.exist;
                            return [2 /*return*/];
                    }
                });
            }); });
            ...
            beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            nsdoc = _a.sent();
                            return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<ied-plugin .doc=\"", "\" .nsdoc=\"", "\"></ied-plugin>"], ["<ied-plugin .doc=\"", "\" .nsdoc=\"", "\"></ied-plugin>"])), doc, nsdoc))];
                        case 3:
                            element = _a.sent();
                            return [4 /*yield*/, element.requestUpdate()];
                        case 4:
                ...
                beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                nsdoc = _a.sent();
                                return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_5 || (templateObject_5 = __makeTemplateObject(["<ied-plugin .doc=\"", "\" .nsdoc=\"", "\"></ied-plugin>"], ["<ied-plugin .doc=\"", "\" .nsdoc=\"", "\"></ied-plugin>"])), doc, nsdoc))];
                            case 3:
                                element = _a.sent();
                                return [4 /*yield*/, element.requestUpdate()];
                            case 4:
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 4:
                                ...
                                testing_1.expect(element.wizardUI.dialogs[0].querySelectorAll('wizard-textfield').length).to.equal(3);
                                return [2 /*return*/];
                        }
                    });
                }); });

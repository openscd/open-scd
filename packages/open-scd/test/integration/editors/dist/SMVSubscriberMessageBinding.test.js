...
describe('Sampled Values Plugin', function () {
    customElements.define('smv-plugin', SMVSubscriberMessageBinding_js_1["default"]);
    var element;
    var parent;
    var doc;
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    doc = _a.sent();
                    return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<mock-open-scd><smv-plugin .doc=", "></smv-plugin></mock-open-scd>"], ["<mock-open-scd><smv-plugin .doc=", "></smv-plugin></mock-open-scd>"])), doc))];
                case 2:
                    parent = _a.sent();

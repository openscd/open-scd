...
describe('subnetwork-editor wizarding integration', function () {
    describe('edit/add Subnetwork wizard', function () {
        var doc;
        var parent;
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        doc = _c.sent();
                        return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<oscd-wizards .host=", "\n          ><subnetwork-editor\n            .doc=", "\n            .element=", "\n          ></subnetwork-editor\n        ></oscd-wizards>"], ["<oscd-wizards .host=", "\n          ><subnetwork-editor\n            .doc=", "\n            .element=", "\n          ></subnetwork-editor\n        ></oscd-wizards>"])), document, doc, doc.querySelector('SubNetwork')))];
                    case 2:
                        parent = _c.sent();
                        ((_b = (_a = parent === null || parent === void 0 ? void 0 : parent.querySelector('subnetwork-editor')) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector('mwc-icon-button[icon="edit"]')).click();
        ...
        describe('the third input element', function () {
            it('edits the attribute type', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    testing_1.expect(parent.wizardUI.inputs[2].label).to.equal('type');
                    return [2 /*return*/];
                });
            }); });
            it('edits only for valid inputs', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fast_check_1["default"].assert(fast_check_1["default"].asyncProperty(foundation_js_1.regexString(foundation_js_1.regExp.desc, 1), function (type) { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
        ...
        describe('the fourth input element', function () {
            it('edits the attribute ', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    testing_1.expect(parent.wizardUI.inputs[3].label).to.equal('BitRate');
                    return [2 /*return*/];
                });
            }); });
            it('edits only for valid inputs', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fast_check_1["default"].assert(fast_check_1["default"].asyncProperty(foundation_js_1.regexString(foundation_js_1.regExp.decimal), function (BitRate) { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
            ...
            it('rejects edition for invalid inputs', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fast_check_1["default"].assert(fast_check_1["default"].asyncProperty(foundation_js_1.regexString(foundation_js_1.inverseRegExp.decimal, 1), function (BitRate) { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            parent.wizardUI.inputs[3].value = BitRate;

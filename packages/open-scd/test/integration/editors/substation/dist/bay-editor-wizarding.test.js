...
describe('bay-editor wizarding integration', function () {
    var doc;
    var parent;
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    doc = _c.sent();
                    return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<oscd-wizards .host=", "\n        ><bay-editor .element=", "></bay-editor\n      ></oscd-wizards>"], ["<oscd-wizards .host=", "\n        ><bay-editor .element=", "></bay-editor\n      ></oscd-wizards>"])), document, doc.querySelector('Bay')))];
                case 2:
                    parent = _c.sent();
                    ((_b = (_a = parent === null || parent === void 0 ? void 0 : parent.querySelector('bay-editor')) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector('mwc-icon-button[icon="edit"]')).click();

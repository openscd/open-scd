...
require("../../../../src/editors/substation/eq-function-editor.js");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                secondaryAction = ((_a = parent.wizardUI.dialog) === null || _a === void 0 ? void 0 : _a.querySelector('mwc-button[slot="secondaryAction"]'));
...
describe('eq-function-editor wizarding editing integration', function () {
    var doc;
    var parent;
    var element;
    var primaryAction;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<mock-wizard-editor\n          ><eq-function-editor\n            .element=", "\n          ></eq-function-editor\n        ></mock-wizard-editor>"], ["<mock-wizard-editor\n          ><eq-function-editor\n            .element=",
                            "\n          ></eq-function-editor\n        ></mock-wizard-editor>"])), doc.querySelector('ConductingEquipment[name="QA1"] > EqFunction')))];
                case 2:
                    parent = (_a.sent());
    ...
    describe('open create wizard for element EqSubFunction', function () {
        var nameField;
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ((_a = element === null || element === void 0 ? void 0 : element.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('mwc-list-item[value="EqSubFunction"]')).click();
        ...
        it('does not add EqSubFunction if name attribute is not unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqSubFunc"]')).to.exist;
                        nameField.value = 'myEqSubFunc';
                        primaryAction.click();
                        return [4 /*yield*/, parent.updateComplete];
                    case 1:
                        _a.sent();
                        testing_1.expect(doc.querySelectorAll('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqSubFunc"]').length).to.equal(1);
                        return [2 /*return*/];
                }
            });
        }); });
        it('does add EqFunction if name attribute is unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="someNewEqSubFunction"]')).to.not.exist;
                        nameField.value = 'someNewEqSubFunction';
                        return [4 /*yield*/, parent.updateComplete];
                    case 1:
                        _a.sent();
                        primaryAction.click();
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="someNewEqSubFunction"]')).to.exist;
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('open edit wizard', function () {
        ...
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        element.element = doc.querySelector('PowerTransformer[name="myPtr3"] > EqFunction[name="myEqFuncQB3"]');
        ...
        it('does not update Function if name attribute is not unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelectorAll('PowerTransformer[name="myPtr3"] > EqFunction[name="myEqFuncQB2"]')).to.lengthOf(1);
        ...
        it('does update Function if name attribute is unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        primaryAction.click();
                        testing_1.expect(doc.querySelector('PowerTransformer[name="myPtr3"] > EqFunction[name="someNewFunction"]')).to.exist;
                        testing_1.expect(doc.querySelector('PowerTransformer[name="myPtr3"] > EqFunction[name="myEqFuncQB3"]')).to.not.exist;
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('add selected LNode instances to SubFcuntion parent', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] > EqFunction > LNode[iedName="None"][lnClass="CSWI"][lnInst="1"]')).to.exist;
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] > EqFunction > LNode[iedName="None"][lnClass="CSWI"][lnInst="2"]')).to.exist;
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('has a delete icon button that', function () {
        ...
        it('removes the attached EqFunction element from the document', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqSubFunc"]')).to.exist;
                    ...
                    case 1:
                        _a.sent();
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqSubFunc"]')).to.not.exist;
                        return [2 /*return*/];
                }
            });
        }); });

...
require("../../../../src/editors/substation/eq-sub-function-editor.js");
...
describe('eq-sub-function-editor wizarding editing integration', function () {
    var doc;
    var parent;
    var element;
    var primaryAction;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<mock-wizard-editor\n          ><eq-sub-function-editor\n            .element=", "\n          ></eq-sub-function-editor\n        ></mock-wizard-editor>"], ["<mock-wizard-editor\n          ><eq-sub-function-editor\n            .element=",
                            "\n          ></eq-sub-function-editor\n        ></mock-wizard-editor>"])), doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction')))];
                case 2:
                    parent = (_a.sent());
    ...
    describe('open create wizard for element EqSubFunction', function () {
        ...
        it('does not add EqSubFunction if name attribute is not unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqSubSubFunction"]')).to.exist;
                        nameField.value = 'myEqSubSubFunction';
                        primaryAction.click();
                        return [4 /*yield*/, parent.updateComplete];
                    case 1:
                        _a.sent();
                        testing_1.expect(doc.querySelectorAll('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqSubSubFunction"]').length).to.equal(1);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('open edit wizard', function () {
        ...
        it('does not update EqSubFunction if name attribute is not unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelectorAll('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqFunc2"]')).to.lengthOf(1);
        ...
        it('does update EqSubFunction if name attribute is unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        primaryAction.click();
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="someNewFunction"]')).to.exist;
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqSubSubFunction"]')).to.not.exist;
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('add selected LNode instances to SubFcuntion parent', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction > LNode[iedName="None"][lnClass="CSWI"][lnInst="1"]')).to.exist;
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction > LNode[iedName="None"][lnClass="CSWI"][lnInst="2"]')).to.exist;
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('has a delete icon button that', function () {
        ...
        it('removes the attached Function element from the document', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('ConductingEquipment[name="QA1"] EqSubFunction[name="myEqSubSubFunction"]')).to.exist;

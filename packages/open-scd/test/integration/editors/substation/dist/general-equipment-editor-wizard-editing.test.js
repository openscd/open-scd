...
require("../../../../src/editors/substation/general-equipment-editor.js");
...
describe('general-equipment-editor wizarding editing integration', function () {
    var doc;
    var parent;
    var element;
    describe('edit wizard', function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        secondaryAction = ((_e = parent.wizardUI.dialog) === null || _e === void 0 ? void 0 : _e.querySelector('mwc-button[slot="secondaryAction"]'));
        ...
        it('does not change name attribute if not unique within parent element', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        testing_1.expect((_a = doc.querySelector('GeneralEquipment')) === null || _a === void 0 ? void 0 : _a.getAttribute('name')).to.equal(oldName);
                        return [2 /*return*/];
                }
            });
        }); });
        it('changes name attribute on primary action', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        testing_1.expect((_a = doc.querySelector('GeneralEquipment')) === null || _a === void 0 ? void 0 : _a.getAttribute('name')).to.equal('newName');
                        return [2 /*return*/];
                }
            });
        }); });
        it('changes type attribute on primary action', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        testing_1.expect((_a = doc.querySelector('GeneralEquipment')) === null || _a === void 0 ? void 0 : _a.getAttribute('type')).to.equal('newAXN');
                        return [2 /*return*/];
                }
            });
        }); });
        it('changes desc attribute on primary action', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        testing_1.expect((_a = doc.querySelector('GeneralEquipment')) === null || _a === void 0 ? void 0 : _a.getAttribute('desc')).to.equal('newDesc');
                        return [2 /*return*/];
                }
            });
        }); });
        it('deletes desc attribute if wizard-textfield is deactivated', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        _b.sent();
                        testing_1.expect((_a = doc.querySelector('GeneralEquipment')) === null || _a === void 0 ? void 0 : _a.getAttribute('desc')).to.be["null"];
                        return [2 /*return*/];
                }
            });
        }); });
        describe('has a delete icon button that', function () {
            ...
            it('removes the attached GeneralEquipment element from the document', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            testing_1.expect(doc.querySelector('Substation[name="AA1"] > GeneralEquipment[name="genSub"]')).to.exist;
                            return [4 /*yield*/, deleteButton.click()];
                        case 1:
                            _a.sent();
                            testing_1.expect(doc.querySelector('Substation[name="AA1"] > GeneralEquipment[name="genSub"]')).to.not.exist;
                            return [2 /*return*/];
                    }
                });
            }); });

...
require("../../../../src/editors/substation/powertransformer-editor.js");
...
describe('powertransformer-editor wizarding editing integration', function () {
    describe('open create wizard for element EqFunction', function () {
        ...
        it('does not add EqFunction if name attribute is not unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('PowerTransformer[name="myPtr2"] > EqFunction[name="myEqFuncPtr2"]')).to.exist;
                        nameField.value = 'myEqFuncPtr2';
                        primaryAction.click();
                        return [4 /*yield*/, parent.updateComplete];
                    case 1:
                        _a.sent();
                        testing_1.expect(doc.querySelectorAll('PowerTransformer[name="myPtr2"] > EqFunction[name="myEqFuncPtr2"]').length).to.equal(1);
                        return [2 /*return*/];
                }
            });
        }); });
        it('does add EqFunction if name attribute is unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('PowerTransformer[name="myPtr2"] > EqFunction[name="someNewFunction"]')).to.not.exist;
                        nameField.value = 'someNewFunction';
                        return [4 /*yield*/, parent.updateComplete];
                    case 1:
                        _a.sent();
                        primaryAction.click();
                        testing_1.expect(doc.querySelector('PowerTransformer[name="myPtr2"] > EqFunction[name="someNewFunction"]')).to.exist;
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('Open add wizard', function () {
        ...
        it('Should add SubEquipment', function () { return __awaiter(void 0, void 0, void 0, function () {
            var nameTextField, subEquipmentName, primaryAction;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        testing_1.expect(parent.wizardUI.dialog).to.be.undefined;
                        (_a = element === null || element === void 0 ? void 0 : element.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector("mwc-icon-button[icon='playlist_add']").click();
                        (_b = element === null || element === void 0 ? void 0 : element.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector("mwc-list-item[value='SubEquipment']").click();
                        return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, 100); })];
                    case 1:
                        _d.sent(); // await animation
                        testing_1.expect(parent.wizardUI.dialog).to.exist;
                        nameTextField = parent.wizardUI.dialog.querySelector('wizard-textfield[label="name"]');
                        subEquipmentName = 'unique-name';
                    ...
                    case 3:
                        _d.sent();
                        testing_1.expect(doc.querySelectorAll("PowerTransformer[name=\"myPtr2\"] > SubEquipment[name=\"" + subEquipmentName + "\"]").length).to.equal(1);
                        return [2 /*return*/];
                }
            });
        }); });

...
require("../../../../src/editors/substation/function-editor.js");
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    subFunctionMenuItem = (_b = element === null || element === void 0 ? void 0 : element.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector("mwc-list-item[value='SubFunction']");
...
describe('function-editor wizarding editing integration', function () {
    var doc;
    var parent;
    var element;
    var primaryAction;
    ...
    describe('open create wizard for element SubFunction', function () {
        ...
        it('does not add SubFunction if name attribute is not unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('Substation > Function > SubFunction[name="mySubFunc"]')).to.exist;
                        nameField.value = 'mySubFunc';
                        primaryAction.click();
                        return [4 /*yield*/, parent.updateComplete];
                    case 1:
                        _a.sent();
                        testing_1.expect(doc.querySelectorAll('Substation > Function > SubFunction[name="mySubFunc"]').length).to.equal(1);
                        return [2 /*return*/];
                }
            });
        }); });
        it('does add SubFunction if name attribute is unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('Substation > Function > SubFunction[name="someNewFunction"]')).to.not.exist;
                        nameField.value = 'someNewFunction';
                        return [4 /*yield*/, parent.updateComplete];
                    case 1:
                        _a.sent();
                        primaryAction.click();
                        testing_1.expect(doc.querySelector('Substation > Function > SubFunction[name="someNewFunction"]')).to.exist;
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('open edit wizard', function () {
        ...
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        element.element = doc.querySelector('Bay[name="COUPLING_BAY"] > Function[name="bayName"]');
        ...
        it('does not update Function if name attribute is not unique', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelectorAll('Bay[name="COUPLING_BAY"] > Function[name="bay2Func"]')).to.lengthOf(1);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        testing_1.expect(doc.querySelector('Bay[name="COUPLING_BAY"] > Function[name="bayName"]')).to.not.exist;
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('open create wizard for element LNode', function () {
        ...
        it('add selected LNode instances to Function parent', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        testing_1.expect(doc.querySelector('Function > LNode[iedName="None"][lnClass="CSWI"][lnInst="1"]')).to.exist;
                        testing_1.expect(doc.querySelector('Function > LNode[iedName="None"][lnClass="CSWI"][lnInst="2"]')).to.exist;
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('has a delete icon button that', function () {
        ...
        it('removes the attached Function element from the document', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testing_1.expect(doc.querySelector('Substation[name="AA1"] > Function[name="myFunc"]')).to.exist;
                        return [4 /*yield*/, deleteButton.click()];
                    case 1:
                        _a.sent();
                        testing_1.expect(doc.querySelector('Substation[name="AA1"] > Function[name="myFunc"]')).to.not.exist;
                        return [2 /*return*/];
                }
            });
        }); });

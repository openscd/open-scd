...
require("../../../../src/editors/substation/tapchanger-editor.js");
...
describe('tapchanger-editor wizarding editing integration', function () {
    var doc;
    var parent;
    var element;
    describe('edit wizard', function () {
        ...
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, fetch('/test/testfiles/editors/substation/TapChanger.scd')
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<mock-wizard-editor\n            ><tapchanger-editor\n              .element=", "\n            ></tapchanger-editor\n          ></mock-wizard-editor>"], ["<mock-wizard-editor\n            ><tapchanger-editor\n              .element=",
                                "\n            ></tapchanger-editor\n          ></mock-wizard-editor>"])), doc.querySelector('TransformerWinding[name="withTapChanger1"] > TapChanger[name="tapChComplet"]')))];
                    case 2:
                        parent = (_f.sent());
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        testing_1.expect((_a = doc
                            .querySelector('TransformerWinding[name="withTapChanger1"] > TapChanger[name="tapChComplet"]')) === null || _a === void 0 ? void 0 : _a.getAttribute('name')).to.equal(oldName);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        testing_1.expect((_a = doc
                            .querySelector('TransformerWinding[name="withTapChanger1"] > TapChanger[name="tapChComplet"]')) === null || _a === void 0 ? void 0 : _a.getAttribute('desc')).to.equal('newDesc');
                        return [2 /*return*/];
                }
            });
        }); });
        it('changes virtual attribute on primary action', function () { return __awaiter(void 0, void 0, void 0, function () {
            var virtualCheckbox;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        virtualCheckbox = ((_a = parent.wizardUI.dialog) === null || _a === void 0 ? void 0 : _a.querySelector('wizard-checkbox[label="virtual"]'));
                    ...
                    case 1:
                        ...
                        testing_1.expect((_b = doc
                            .querySelector('TransformerWinding[name="withTapChanger1"] > TapChanger[name="tapChComplet"]')) === null || _b === void 0 ? void 0 : _b.getAttribute('virtual')).to.equal('false');
                        return [2 /*return*/];
                }
            });
        }); });
        describe('has a delete icon button that', function () {
            ...
            it('removes the attached TapChanger element from the document', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            testing_1.expect(doc.querySelector('TransformerWinding[name="withTapChanger1"] > TapChanger[name="tapChComplet"]')).to.exist;
                            return [4 /*yield*/, deleteButton.click()];
                        case 1:
                            _a.sent();
                            testing_1.expect(doc.querySelector('TransformerWinding[name="withTapChanger1"] > TapChanger[name="tapChComplet"]')).to.not.exist;
                            return [2 /*return*/];
                    }
                });
            }); });

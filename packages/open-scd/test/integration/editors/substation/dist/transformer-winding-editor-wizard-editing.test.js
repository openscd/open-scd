...
require("../../../../src/editors/substation/transformer-winding-editor.js");
...
describe('transformer-winding-editor wizarding editing integration', function () {
    var doc;
    var parent;
    var element;
    describe('edit wizard', function () {
        ...
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, fetch('test/testfiles/editors/substation/TransformerWinding.scd')
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<mock-wizard-editor\n            ><transformer-winding-editor\n              .element=", "\n            ></transformer-winding-editor\n          ></mock-wizard-editor>"], ["<mock-wizard-editor\n            ><transformer-winding-editor\n              .element=",
                                "\n            ></transformer-winding-editor\n          ></mock-wizard-editor>"])), doc.querySelector('PowerTransformer[name="pTransVolt"] > TransformerWinding[name="some"]')))];
                    case 2:
                        parent = (_f.sent());
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        testing_1.expect((_a = doc
                            .querySelector('PowerTransformer[name="pTransVolt"] > TransformerWinding[name="some"]')) === null || _a === void 0 ? void 0 : _a.getAttribute('name')).to.equal(oldName);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        testing_1.expect((_a = doc
                            .querySelector('PowerTransformer[name="pTransVolt"] > TransformerWinding[name="some"]')) === null || _a === void 0 ? void 0 : _a.getAttribute('desc')).to.equal('newDesc');
                        return [2 /*return*/];
                }
            });
        }); });
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        testing_1.expect((_b = doc
                            .querySelector('PowerTransformer[name="pTransVolt"] > TransformerWinding[name="some"]')) === null || _b === void 0 ? void 0 : _b.getAttribute('virtual')).to.equal('true');
                        return [2 /*return*/];
                }
            });
        }); });
        describe('has a delete icon button that', function () {
            ...
            it('removes the attached TransformerWinding element from the document', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            testing_1.expect(doc.querySelector('PowerTransformer[name="pTransVolt"] > TransformerWinding[name="some"]')).to.exist;
                            return [4 /*yield*/, deleteButton.click()];
                        case 1:
                            _a.sent();
                            testing_1.expect(doc.querySelector('PowerTransformer[name="pTransVolt"] > TransformerWinding[name="some"]')).to.not.exist;
                            return [2 /*return*/];
                    }
                });
            }); });

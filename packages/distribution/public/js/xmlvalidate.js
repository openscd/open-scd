...
var wasmBinaryFile = 'xmlvalidate.wasm';
...
var _validate = (Module['_validate'] = function () {
  return (_validate = Module['_validate'] = Module['asm']['s']).apply(
    null,
    arguments
  );
});
...
var stackSave = (Module['stackSave'] = function () {
  return (stackSave = Module['stackSave'] = Module['asm']['w']).apply(
    null,
    arguments
  );
});
var stackRestore = (Module['stackRestore'] = function () {
  return (stackRestore = Module['stackRestore'] = Module['asm']['x']).apply(
    null,
    arguments
  );
});

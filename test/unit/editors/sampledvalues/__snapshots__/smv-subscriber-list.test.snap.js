...
snapshots["smv-subscriber-list looks like the latest snapshot with a document loaded"] = 
`<section tabindex="0">
  <h1>
    [subscription.subscriberGoose.title]
  </h1>
...
`;
/* end snapshot smv-subscriber-list looks like the latest snapshot with a document loaded */

snapshots["smv-subscriber-list looks like the latest snapshot without a doc loaded"] = 
`<section tabindex="0">
  <h1>
    [subscription.subscriberGoose.title]
  </h1>
...
`;
/* end snapshot smv-subscriber-list looks like the latest snapshot without a doc loaded */

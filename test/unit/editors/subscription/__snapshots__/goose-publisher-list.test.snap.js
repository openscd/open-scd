...
snapshots["goose-publisher-list looks like the latest snapshot with a document loaded"] = 
`<section tabindex="0">
  <h1>
    [subscription.publisherGoose.title]
  </h1>
...
`;
/* end snapshot goose-publisher-list looks like the latest snapshot with a document loaded */

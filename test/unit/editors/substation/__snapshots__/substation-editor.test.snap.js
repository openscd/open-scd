...
snapshots["substation-editor with general-equipment children looks like the latest snapshot"] = 
`<action-pane
  label="AA1 "
  tabindex="0"
>
...
`;
/* end snapshot substation-editor with general-equipment children looks like the latest snapshot */

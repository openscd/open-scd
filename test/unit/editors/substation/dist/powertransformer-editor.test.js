...
describe('powertransformer-editor', function () {
    var element;
    var validSCL;
    var wizardEvent;
    var actionEvent;
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    validSCL = _a.sent();
                    return [4 /*yield*/, testing_1.fixture(testing_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<powertransformer-editor\n          .element=", "\n        ></powertransformer-editor>"], ["<powertransformer-editor\n          .element=", "\n        ></powertransformer-editor>"])), validSCL.querySelector('PowerTransformer')))];
                case 2:
                    element = (_a.sent());
    ...
    describe('rendered as action icon', function () {
        ...
        it('triggers edit wizard for Linking LNode element on action button click', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
        ...
        it('triggers edit wizard for PowerTransformer element on action button click', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('triggers remove powertransformer action on action button click', function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:

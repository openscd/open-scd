...
snapshots["Subscription Plugin in Publisher view initially the IED list looks like the latest snapshot"] = 
`<section tabindex="0">
  <h1>
    [subscription.goose.publisherGoose.subscriberTitle]
  </h1>
...
`;
/* end snapshot Subscription Plugin in Publisher view initially the IED list looks like the latest snapshot */
...
snapshots["Subscription Plugin in Subscriber view when selecting an IED the list on the right will initially show the subscribed / partially subscribed / not subscribed IEDs"] = 
`<section tabindex="0">
  <h1>
    [subscription.goose.subscriberGoose.publisherTitle]
  </h1>
...
`;
/* end snapshot Subscription Plugin in Subscriber view when selecting an IED the list on the right will initially show the subscribed / partially subscribed / not subscribed IEDs */

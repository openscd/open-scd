...
snapshots["subnetwork-editor wizarding integration add ConnectedAP wizard looks like the latest snapshot"] = 
`<mwc-dialog
  defaultaction="close"
...
`;
/* end snapshot subnetwork-editor wizarding integration add ConnectedAP wizard looks like the latest snapshot */

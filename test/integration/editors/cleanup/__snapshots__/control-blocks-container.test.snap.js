...
snapshots["Cleanup: Control Blocks Container Unreferenced Control Blocks looks like the latest snapshot with a test file loaded"] = 
`<section tabindex="1">
  <div>
    <h1>
      [cleanup.unreferencedControls.title]
...
`;
/* end snapshot Cleanup: Control Blocks Container Unreferenced Control Blocks looks like the latest snapshot with a test file loaded */

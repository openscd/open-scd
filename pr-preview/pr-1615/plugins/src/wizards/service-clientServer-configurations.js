...
function createClientServerConfigurationsWizard(parent) {
  const content = {
    ...
    discoverCapabilities: {
      ...
      getDataObjectDefinition: parent.querySelector("GetDataObjectDefinition") ? "true" : null,
      dataObjectDirectory: parent.querySelector("DataObjectDirectory") ? "true" : null,
      ...
      setDataSetDirectory: parent.querySelector("DataSetDirectory") ? "true" : null,
      readWrite: parent.querySelector("ReadWrite") ? "true" : null
    },
    functionalNaming: {
      confLdName: parent.querySelector("ConfLdName") ? "true" : null,
      supportsLdName: parent.querySelector("ClientServices")?.getAttribute("supportsLdName") ?? null
    },
    clientCapabilities: {
      maxAttributes: parent.querySelector("ClientServices")?.getAttribute("maxAttributes") ?? null,
      timerActivatedControl: parent.querySelector("TimerActivatedControl") ? "true" : null,

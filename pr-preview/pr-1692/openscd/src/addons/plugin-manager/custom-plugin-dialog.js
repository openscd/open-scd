...
export let OscdCustomPluginDialog = class extends LitElement {
  render() {
    return html`
  ...
  handleAddPlugin() {
    if (!(this.pluginSrcInput.checkValidity() && this.pluginNameInput.checkValidity() && this.pluginKindList.selected && this.requireDoc && this.positionList.selected))
      return;
...
__decorate([
  query("#dialog")
], OscdCustomPluginDialog.prototype, "dialog", 2);
__decorate([
  query("#pluginSrcInput")
], OscdCustomPluginDialog.prototype, "pluginSrcInput", 2);
__decorate([
  query("#pluginNameInput")
], OscdCustomPluginDialog.prototype, "pluginNameInput", 2);
__decorate([
  query("#pluginKindList")
], OscdCustomPluginDialog.prototype, "pluginKindList", 2);
__decorate([
  query("#requireDoc")
], OscdCustomPluginDialog.prototype, "requireDoc", 2);
__decorate([
  query("#positionList")
], OscdCustomPluginDialog.prototype, "positionList", 2);
__decorate([
  query("#addButton")
], OscdCustomPluginDialog.prototype, "addButton", 2);

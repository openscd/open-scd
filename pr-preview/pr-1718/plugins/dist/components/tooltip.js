...
let OscdTooltip = class OscdTooltip extends LitElement {
    constructor() {
        super(...arguments);
        this.text = '';
        this.visible = false;
...
], OscdTooltip.prototype, "text", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], OscdTooltip.prototype, "visible", void 0);
__decorate([
    property({ type: Number })
], OscdTooltip.prototype, "x", void 0);
__decorate([
    property({ type: Number })
], OscdTooltip.prototype, "y", void 0);
__decorate([
    property({ type: Number })
], OscdTooltip.prototype, "offset", void 0);

  ...
  return [
    {
      ...
      content: [
        html`<filtered-list multi
          ...
          const reference = (extRef.getAttribute("prefix") ?? "") + extRef.getAttribute("lnClass") + (extRef.getAttribute("lnInst") ?? "") + ">" + extRef.getAttribute("doName") + "." + (extRef.getAttribute("daName") ?? "");

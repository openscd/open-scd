...
function createNetworkingWizard(parent) {
  const content = {
    ...
    timeSyncProt: {
      ...
      iec61850_9_3: parent.querySelector("TimeSyncProt")?.getAttribute("iec61850_9_3") ?? null,
    ...
    cs_TimeSyncProt: {
      sntp: parent.querySelector("ClientServices > TimeSyncProt")?.getAttribute("sntp") ?? null,
      iec61850_9_3: parent.querySelector("ClientServices > TimeSyncProt")?.getAttribute("iec61850_9_3") ?? null,
      c37_238: parent.querySelector("ClientServices > TimeSyncProt")?.getAttribute("c37_238") ?? null,
      other: parent.querySelector("ClientServices > TimeSyncProt")?.getAttribute("other") ?? null
    },
    cs_McSecurity: {
      signature: parent.querySelector("ClientServices > McSecurity")?.getAttribute("signature") ?? null,
      encryption: parent.querySelector("ClientServices > McSecurity")?.getAttribute("encryption") ?? null
    },
    redProt: {

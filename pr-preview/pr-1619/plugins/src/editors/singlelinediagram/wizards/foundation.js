...
export function updateNamingAndCoordinatesAction(element) {
  return (inputs) => {
    ...
    if (name === getNameAttribute(element) && desc === getDescAttribute(element) && xCoordinate === getXCoordinateAttribute(element) && yCoordinate === getYCoordinateAttribute(element)) {
      return [];
    }

...
function createPanZoom(domElement, options) {
  ...
  var filterKey = typeof options.filterKey === 'function' ? options.filterKey : noop$2;
  ...
  var beforeWheel = options.beforeWheel || noop$2;
  var beforeMouseDown = options.beforeMouseDown || noop$2;

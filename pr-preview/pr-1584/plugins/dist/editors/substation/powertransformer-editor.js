...
let PowerTransformerEditor = PowerTransformerEditor_1 = class PowerTransformerEditor extends LitElement {
    constructor() {
        super(...arguments);
        this.editCount = -1;
    ...
    renderContentPane() {
      ...
      <abbr slot="action" title="${get('move')}">
        <mwc-icon-button
          ...
          mini
          @click="${() => {
            startMove(this, PowerTransformerEditor_1, [
                SubstationEditor,
                VoltageLevelEditor,
                BayEditor,
            ]);
    ...
    renderTransformerWinding() {
        ...
        return transformerWindings.length
          ...
          ${transformerWindings.map(transformerWindings => html `<transformer-winding-editor
                .editCount=${this.editCount}
                .doc=${this.doc}
...
__decorate([
    query('mwc-menu')
], PowerTransformerEditor.prototype, "addMenu", void 0);
__decorate([
    query('mwc-icon-button[icon="playlist_add"]')
], PowerTransformerEditor.prototype, "addButton", void 0);
PowerTransformerEditor = PowerTransformerEditor_1 = __decorate([
    customElement('powertransformer-editor')
], PowerTransformerEditor);
export { PowerTransformerEditor };
//# sourceMappingURL=powertransformer-editor.js.map
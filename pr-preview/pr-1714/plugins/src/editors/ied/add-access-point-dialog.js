...
export let AddAccessPointDialog = class extends LitElement {
  constructor() {
    super(...arguments);
    this.apName = "";
  ...
  handleCreate() {
    if (this.apNameField.checkValidity()) {
      const data = {
        ...
        serverAtApName: this.createServerAt ? this.serverAtApName : void 0,
        serverAtDesc: this.createServerAt && this.serverAtDesc ? this.serverAtDesc : void 0
      };
      this.onConfirm(data);
      this.close();
    }
  ...
  render() {
    ...
    let serverAtSection = html``;
    if (accessPointsWithServer.length > 0) {
      if (this.createServerAt && (!this.serverAtApName || !accessPointsWithServer.includes(this.serverAtApName))) {
      ...
      serverAtSection = html`
        ...
        if (!this.createServerAt)
          this.serverAtApName = "";
      }}
          ></mwc-switch>
        </mwc-formfield>
        ${this.createServerAt ? html`
              <mwc-select
        ...
        this.serverAtApName = e.target.value;
              ...
              >
                ${accessPointsWithServer.map((ap) => html`<mwc-list-item value=${ap}>${ap}</mwc-list-item>`)}
              </mwc-select>
              <mwc-textfield
    ...
    return html`
      ...
      this.apName = e.target.value;
        ...
        <mwc-button
          ...
          ?disabled=${!this.apNameField || !this.apNameField.validity.valid || this.createServerAt && !this.serverAtApName}
        >
          ${translate("add")}
        </mwc-button>
      </mwc-dialog>
...
__decorate([
  property()
], AddAccessPointDialog.prototype, "doc", 2);
__decorate([
  property()
], AddAccessPointDialog.prototype, "ied", 2);
__decorate([
  property({type: Function})
], AddAccessPointDialog.prototype, "onConfirm", 2);
__decorate([
  query("#createAccessPointDialog")
], AddAccessPointDialog.prototype, "dialog", 2);
__decorate([
  query("#apName")
], AddAccessPointDialog.prototype, "apNameField", 2);
__decorate([
  state()
], AddAccessPointDialog.prototype, "apName", 2);
__decorate([
  state()
], AddAccessPointDialog.prototype, "createServerAt", 2);
__decorate([
  state()
], AddAccessPointDialog.prototype, "serverAtApName", 2);
__decorate([
  state()
], AddAccessPointDialog.prototype, "serverAtDesc", 2);

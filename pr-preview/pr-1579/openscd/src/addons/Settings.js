...
__decorate([
  query("#language")
], OscdSettings.prototype, "languageUI", 2);
__decorate([
  query("#dark")
], OscdSettings.prototype, "darkThemeUI", 2);
__decorate([
  query("#mode")
], OscdSettings.prototype, "modeUI", 2);
__decorate([
  query("#showieds")
], OscdSettings.prototype, "showiedsUI", 2);
__decorate([
  query("#nsdoc-file")
], OscdSettings.prototype, "nsdocFileUI", 2);

...
function createSampledValuesWizard(parent) {
  const content = {
    controlBlockConfiguration: {
      ...
      samplesPerSec: parent.querySelector("SMVSettings")?.getAttribute("samplesPerSec") ?? null,
      synchSrcId: parent.querySelector("SMVSettings")?.getAttribute("synchSrcId") ?? null,
      pdcTimeStamp: parent.querySelector("SMVSettings")?.getAttribute("pdcTimeStamp") ?? null,
      kdaParticipant: parent.querySelector("SMVSettings")?.getAttribute("kdaParticipant") ?? null,
      signature: parent.querySelector("SMVSettings > McSecurity")?.getAttribute("signature") ?? null,
      encryption: parent.querySelector("SMVSettings > McSecurity")?.getAttribute("encryption") ?? null,
      smpRateVal: parent.querySelector("SMVSettings>SmpRate")?.childNodes[0]?.nodeValue ?? null,
      samplesPerSecVal: parent.querySelector("SMVSettings > SamplesPerSec")?.childNodes[0]?.nodeValue ?? null,
      secPerSamplesVal: parent.querySelector("SMVSettings > SecPerSamples")?.childNodes[0]?.nodeValue ?? null
    },
  ...
  return isEmptyObject(content) ? null : [
    ...
    ...createFormElementsFromInputs([
      ...
      },
      {
        ...
        maybeValue: content.controlBlockConfiguration.samplesPerSec?.toString() ?? null,
        nullable: true,
        default: false
      },
      {
      ...
      },
      {
        ...
        maybeValue: content.controlBlockConfiguration.pdcTimeStamp?.toString() ?? null,
        nullable: true,
        default: false
      },
      {
        ...
        maybeValue: content.controlBlockConfiguration.kdaParticipant?.toString() ?? null,
        nullable: true,
        default: false
      },
      {
      ...
      },
      {
        ...
        maybeValue: content.controlBlockConfiguration.samplesPerSecVal?.toString() ?? null,
        nullable: true
      },
      {
        kind: "TextField",
        ...
        maybeValue: content.controlBlockConfiguration.secPerSamplesVal?.toString() ?? null,
        nullable: true
      }
    ]),
